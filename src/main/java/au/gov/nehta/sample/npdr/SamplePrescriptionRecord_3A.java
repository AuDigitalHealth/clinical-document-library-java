...
public class SamplePrescriptionRecord_3A {
    public static void main(String[] args) {
        ...
        List<Telecom> prescriberCommunicationList = new ArrayList<>();
        ...
        minIntervalBetweenRepeats.setNarrative("3 weeks"); // a text description of this time quantity
        ...
        builder
                ...
                .therapeuticGoodGenericName("Therapeutic good generic name")
                .formula(formula)
                .reasonForTherapeuticGood(reasonForTherapeuticGood)
                .therapeuticGoodGenericStrength("Therapeutic good strength")
        ...
        */
        ...
        String cdaString;
        try {
            cdaString = documentToXML(prescriptionCreator.create());
        } catch (Exception e) {
     ...
     */
    protected static UniqueIdentifier uuidRoot(String id) {
