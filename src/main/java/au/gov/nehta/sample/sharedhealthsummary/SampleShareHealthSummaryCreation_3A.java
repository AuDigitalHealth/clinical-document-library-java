...
public class SampleShareHealthSummaryCreation_3A {
    public static void main(String[] args) throws Exception {
        ...
        ExtendedEmploymentOrganisationImpl employmentDetails = new ExtendedEmploymentOrganisationImpl(
                Collections.singletonList(authorHPIO), Collections.singletonList(authorOrgAddress), Arrays.asList(authorOrgTelephone, authorOrgFax), "Sarahs Clinic");
        ...
        KnownMedication med1 = new KnownMedicationImpl(
                new AMTv3Code("999999009", "Test Medication only, not real"),
                "Directions",
        ...
        // Alternate for the case when there are no medications
        ...
        ProblemDiagnosis problem2 = new ProblemDiagnosisImpl(
                ...
                new PrecisionDate(Precision.DAY, LocalDate.of(2000, 2, 28).atStartOfDay(ZoneId.systemDefault())), null, null);
        ...
        ProblemDiagnosis problem3 = new ProblemDiagnosisImpl(
                ...
                new PrecisionDate(Precision.DAY, LocalDate.of(2014, 5, 30).atStartOfDay(ZoneId.systemDefault())), null);
        ...
        ProblemDiagnosis problem4 = new ProblemDiagnosisImpl(
                ...
                new PrecisionDate(Precision.DAY, LocalDate.of(2014, 6, 30).atStartOfDay(ZoneId.systemDefault())), "patient took a holiday and the problem was resolved");
        ...
        RestrictedTimeInterval time = RestrictedTimeInterval
                .getLowHighInstance(new PrecisionDate(Precision.DAY,
                                LocalDate.of(2003, 1, 1).atStartOfDay(ZoneId.systemDefault())),
                        PrecisionDate.today());
        // Set the explicit narrative form of this time interval
        time.setNarrative("since 1 Jan 2003, ongoing");

        UncatagorisedMedicalHistoryItem item1 = new UncatagorisedMedicalHistoryItemImpl("Description",
                time,
        ...
        UncatagorisedMedicalHistoryItem item3 = new UncatagorisedMedicalHistoryItemImpl("Vitamin C dietary supplement", null, null);
        ...
        Immunisation im1 = new ImmunisationImpl(
                new AMTv3Code("74993011000036102", "measles virus (Schwarz) live attenuated vaccine + mumps virus (Jeryl Lynn, strain RIT 4385) live attenuated vaccine + rubella virus (Wistar RA 27/3) live attenuated vaccine"),
