...
public enum SourceOfDeathNotification implements EnumTuple {
	OFFICIAL_DEATH_CERTIFICATE_OR_DEATH_REGISTER( "1", "Official death certificate or death register" ), HEALTHCARE_PROVIDER( "2", "Healthcare provider" ), RELATIVE( "3", "Relative" ), OTHER( "4",
			"Other" ), UNKNOWN( "9", "Unknown" );
