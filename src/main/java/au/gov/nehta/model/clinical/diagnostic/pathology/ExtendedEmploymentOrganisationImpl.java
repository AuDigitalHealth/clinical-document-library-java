...
public class ExtendedEmploymentOrganisationImpl extends EmploymentOrganisationImpl implements ExtendedEmploymentOrganisation {
    ...
    /**
     * @param identifiers                    A number or code issued for the purpose of identifying a
     ...
     * @param addresses                      A list of addresses for this organisation
     * @param electronicCommunicationDetails A list of Telecoms for this organisation
     */
