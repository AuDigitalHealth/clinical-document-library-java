...
public class PersonNameImpl implements PersonName {
    private List<String> nameTitle = new ArrayList<>(1);
    private String familyName;
    private List<String> givenName = new ArrayList<>(2);
    private List<String> nameSuffix = new ArrayList<>(1);
    private Boolean preferredNameIndicator;
    private List<PersonNameUsage> personNameUsage = new ArrayList<>(1);
