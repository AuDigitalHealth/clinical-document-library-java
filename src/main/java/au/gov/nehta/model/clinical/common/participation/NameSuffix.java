...
public enum NameSuffix implements EnumTuple {
    JUNIOR("Junior", "Jnr"), MEMBER_OF_PARLIAMENT("Member of Parliament", "MP"),
    QUEENS_COUNSEL("Queens Counsel", "QC"), SENIOR("Senior", "Snr"),
    FIRST("First", "I"), SECOND("Second", "II"),
    THIRD("Third", "III"), FOURTH("Fourth", "IV"),
    FIFTH("Fifth", "V"), SIXTH("Sixth", "VI"),
    SEVENTH("Seventh", "VII"), EIGHTH("Eighth", "VIII"),
    NINTH("Ninth", "IX"), TENTH("Tenth", "X");
