...
public class DateOfBirthDetailImpl implements DateOfBirthDetail {
    ...
    public DateOfBirthDetailImpl(ZonedDateTime dateOfBirth, DateAccuracy accuracy) {
    ...
    public DateOfBirthDetailImpl(ZonedDateTime dateOfBirth) {
        ArgumentUtils.checkNotNull(dateOfBirth, "Date Of Birth");
        this.dateOfBirth = new PrecisionDate(Precision.DAY, dateOfBirth);
    }
    ...
    public DateOfBirthDetailImpl(int age) {
        ZonedDateTime d = calucalteDOBFromAge(age);
    ...
    public ZonedDateTime calucalteDOBFromAge(int age) {
        LocalDate dobFromAge = LocalDate.now();
        dobFromAge.minusYears(age);
        return dobFromAge.atStartOfDay(ZoneId.systemDefault());
    }
}
