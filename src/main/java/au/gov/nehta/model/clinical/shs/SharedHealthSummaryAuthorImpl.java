 ...
 */
public class SharedHealthSummaryAuthorImpl implements SharedHealthSummaryAuthor {
	 ...
	 */
	public SharedHealthSummaryAuthorImpl(
			Coded role,
	 ...
	 * 
	 * UUID.
	 * Required CDA element. This is a technical identifier that is used for
