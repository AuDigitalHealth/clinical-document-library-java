...
public class PrescriberInstructionCommunicationMediumImpl implements PrescriberInstructionCommunicationMedium {
	private boolean isCoded;
	private String uncodedValue;
	private PrescriberInstructionCommunicationMediumEnum codedValue;

	PrescriberInstructionCommunicationMediumImpl( String uncodedValue ) {
	...
	public PrescriberInstructionCommunicationMediumImpl( PrescriberInstructionCommunicationMediumEnum prescriberInstructionCommunicationMediumEnum ) {
		ArgumentUtils.checkNotNull( prescriberInstructionCommunicationMediumEnum, "prescriberInstructionCommunicationMediumEnum" );
		this.isCoded = true;
		this.codedValue = prescriberInstructionCommunicationMediumEnum;
	}
