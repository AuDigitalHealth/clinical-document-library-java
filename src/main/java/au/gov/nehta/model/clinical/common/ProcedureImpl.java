...
public class ProcedureImpl implements Procedure {
    ...
    /**
     * @param name      The name of the procedure (to be) performed.
     * @param startTime The start date and/or time for the procedure.
     * @param comment   optional Additional narrative about the procedure not captured
     *                  in other fields.
     */
