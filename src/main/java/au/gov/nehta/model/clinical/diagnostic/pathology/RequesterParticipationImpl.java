...
public class RequesterParticipationImpl implements RequesterParticipation {
    ...
    /**
     * @param role                     The involvement or role of the participant in the related action from a
     ...
     * @param endOfParticipationPeriod The time interval during which the participation in the health care event occurred
    ...
    @Override
    public ZonedDateTime getParticipationEndTime() {
        return endTime;
    }
}
