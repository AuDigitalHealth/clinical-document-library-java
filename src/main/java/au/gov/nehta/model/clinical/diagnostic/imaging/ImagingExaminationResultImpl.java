...
//        ArgumentUtils.checkNotNull( anatomicalRegion, "anatomicalRegion" );
     ...
     *
     * @param imagingResultName    Identification of the imaging examination or procedure
     *                             performed, typically including modality and anatomical
     *                             location (including laterality).
     * @param modality             The imaging method used to perform the examination.
     * @param overallResult        The status of the examination result as a whole.
     * @param imageDateTime        Date, and optionally time, when an observation is clinically
     *                             significant to the condition of the subject of the
     *                             observation.
     * @param examinationProcedure Additional details of imaging examination methodology
     *                             followed.
     * @param anatomicalRegion     Region of body (e.g. head, lower limb) that includes the
     ...
     * @param modality             The imaging method used to perform the examination.
     * @param overallResult        The status of the examination result as a whole.
     * @param relatedImage         A link to, or identifier of, information of interest
     * @param imageDateTime        Date, and optionally time, when an observation is clinically
     *                             significant to the condition of the subject of the
     *                             observation.
     * @param examinationProcedure Additional details of imaging examination methodology
