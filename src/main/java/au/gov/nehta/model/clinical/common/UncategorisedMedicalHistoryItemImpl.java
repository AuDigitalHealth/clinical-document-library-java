 ...
 */
public class UncategorisedMedicalHistoryItemImpl implements UncategorisedMedicalHistoryItem {
    ...
    /**
     * @param description  A description of the problem, diagnosis, intervention or other
