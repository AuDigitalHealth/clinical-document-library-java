...
public class ImmunisationImpl implements Immunisation {
    ...
    /**
     * @param therapeuticGood The vaccine which was the focus of the action.
     *                        <p>
     ...
     */
    public ImmunisationImpl(AMTv3Code therapeuticGood, PreciseDate actionDateTime,
                            Integer sequenceNumber) {

        ArgumentUtils.checkNotNull(therapeuticGood, "therapeuticGood");
     ...
     *
     * @param therapeuticGood
     * @param actionDateTime
     */
    public ImmunisationImpl(Coded therapeuticGood, PreciseDate actionDateTime) {
