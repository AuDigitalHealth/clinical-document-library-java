...
public class PBSPrescriptionTypeCode extends CodeImpl implements Code {
    ...
    /*
     * from the specification: appendix C18 MEDICARE: PBS PRESCRIPTION TYPE VALUES
     */

    public static final String CODE_SYSTEM_NAME = "Prescription Type Values";
    public static final String CODE_SYSTEM = "1.2.36.1.5001.1.1.3.2.6";
