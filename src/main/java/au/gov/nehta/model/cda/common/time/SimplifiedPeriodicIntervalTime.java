 ...
 *
 * @author NeHTA
 * @see PeriodicIntervalTime {@link PeriodicIntervalTime}, {@link TimeQuantity},  {@link SetComponentTime}
 */
public class SimplifiedPeriodicIntervalTime extends SetComponentTime {
     ...
     *
     * @param period an integer value specifying the number of units
     ...
     * </pre>
     *
     * @param quantity an integer value specifying the number of units
     */
