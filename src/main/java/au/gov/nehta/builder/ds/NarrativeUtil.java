...
public class NarrativeUtil {
    ...
    static StrucDocText getHealthProfile(HealthProfile healthProfileObj) {
        ...
        if (null != healthProfileObj.getHealthCareProviders()
                && null != healthProfileObj.getHealthCareProviders().getNominatedPrimaryHealthcareProviders()
                && !healthProfileObj.getHealthCareProviders().getNominatedPrimaryHealthcareProviders().isEmpty()) {
