...
import static au.gov.nehta.builder.common.components.DiagnosticInvestigationComponent.*;
...
import static au.gov.nehta.builder.sr.ServiceReferralCodes.*;
    ...
    private void processAdverseReactions(POCDMT000040StructuredBody structuredBody) {
        ...
        if (null != adverseReactionsObj) {
            ...
            if (null != adverseReactionsObj.getExclusionStatement()) {
                ...
                // If exclusion statement is empty, the Adverse Reaction component can be created
