...
public class NarrativeUtil {
    ...
    private static final String NARRATIVE_DATE_TIME_FORMAT = "d MMM yyyy HH:mm:ssZ";
    private static final String NARRATIVE_DATE_FORMAT = "d MMM yyyy";
    public static final DateTimeFormatter NARRATIVE_DATE_TIME_FORMATTER = DateTimeFormatter.ofPattern(NARRATIVE_DATE_TIME_FORMAT);
    public static final DateTimeFormatter NARRATIVE_DATE_FORMATTER = DateTimeFormatter.ofPattern(NARRATIVE_DATE_FORMAT);
    ...
    public static List<StrucDocTd> getProviderIndividualCells(String fieldName,
        ...
        if (providerIndividualDemographicData != null) {
            ...
            String dateOfBirth =
                    providerIndividualDemographicData.getDateOfBirthDetail().getDateOfBirth().format(NARRATIVE_DATE_TIME_FORMATTER);
