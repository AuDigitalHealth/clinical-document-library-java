...
public class PrescriptionRequestCreatorUtil {
    ...
    public static StrucDocText getInstructionSectionNarrativeBlock(PrescriberInstructionDetail prescriberInstructionDetail,
        ...
        prescriberInstructionTableBody.getTr().add(
                NarrativeUtil.createTableBodyRowWithCellValues(Arrays.asList("Date and Time Prescriber Instruction Received",
                        prescriberInstructionDetail.getDateTimePrescriberInstructionReceived().format(NarrativeUtil.NARRATIVE_DATE_TIME_FORMATTER))));
