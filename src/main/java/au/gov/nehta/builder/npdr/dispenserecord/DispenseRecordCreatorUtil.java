...
public class DispenseRecordCreatorUtil extends DocumentCreatorUtil {
    public static StrucDocText getDispenseItemSectionNarrativeBlock(DispenseItem item,
                                                                    List<Entitlement> subjectOfCareEntitlement,
                                                                    List<Entitlement> dispensingOrganisationEntitlement) {
        ...
        add(itemTable, "Date and Time of Dispense Event",
                item.getEventDate().format(NarrativeUtil.NARRATIVE_DATE_TIME_FORMATTER));
