...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- Prescription Request Clinical Document:  Global Checks -->
    ...
    <pattern name="p-Prescription_Request_Global_Checks-errors"
        id="p-Prescription_Request_Global_Checks-errors"
        see="#p-Prescription_Request_Global_Checks-errors">
       ...
       <!-- 
        ...
        <rule
            ...
            <report test="starts-with(@code, '0')">Error: Prescription Request - Global Clinical Document check
                ...
                of the Prescription_Request_CDA_Implementation_Guide_v0.5 and AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</report>

            <assert test="string-length(@code) &gt;= 6">Error: Prescription Request - Global Clinical
                ...
                such 'code' attributes to find the incorrect attribute(s). Refer to section A1
                of the Prescription_Request_CDA_Implementation_Guide_v0.5 and AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>

            <assert test="number(@code) &gt;= 100001">Error: Prescription Request - Global Clinical Document
                ...
                attribute(s). Refer to section A1 of the Prescription_Request_CDA_Implementation_Guide_v0.5 and
                AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>

            <assert test="string-length(@code) &lt;= 18">Error: Prescription Request - Global Clinical
                Document check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
                ...
                section A1 of the Prescription_Request_CDA_Implementation_Guide_v0.5 and
                AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>

            <assert test="number(@code) &lt;= 999999999999999999">Error: Prescription Request - Global
            ...
            <assert test="normalize-space(@code) = @code">Error: Prescription Request - Global Clinical Document
                check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
                ...
                to section A1 of the Prescription_Request_CDA_Implementation_Guide_v0.5 and
                AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>

            <assert test="string-length(normalize-space(@code)) = string-length(@code)">Error:
                Prescription Request - Global Clinical Document check for
            ...
            <assert test="number(@code) = floor(@code)">Error: Prescription Request - Global Clinical Document
                check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
            ...
            <assert test="number(@code)">Error: Prescription Request - Global Clinical Document check for
                "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
                ...
                the Prescription_Request_CDA_Implementation_Guide_v0.5 and AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>
            ...
            <report
                ...
                Prescription_Request_CDA_Implementation_Guide_v0.5 and AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</report>
...
-->
        ...
        <rule context="ext:asEntityIdentifier">
            ...
            <assert test="@classCode">Error: Prescription Request -
            ...
            <assert test="not(@classCode) or normalize-space(@classCode) != ''">Error: Prescription Request -
                Global Clinical Document check for "ext:asEntityIdentifier" tag -
            ...
            <assert test="ext:id">Error: Prescription Request -
            ...
            <!--
            <assert test="ext:id/@assigningAuthorityName">Error: Prescription Request -
            ...
            <!-- Other attributes of "ext:id" are being tested by Prescription_Request_Global_Checks.sch. -->
            ...
            <!-- The attributes of "ext:code" (code, codeSystem, codeSystemName, displayName) are being tested by Prescription_Request_Global_Checks.sch. -->
        ...
        <rule context="cda:name[not(
            ...
            <report test="cda:family and not(cda:family[@nullFlavor]) and normalize-space(cda:family) = ''"
                >Error: Prescription Request - Global Clinical Document check for "name" tag - The 'family' tag
        ...
        <rule context="cda:addr[not(ancestor::cda:birthplace)]">
            ...
            <assert test="
                ...
                >Error: Prescription Request - Global Clinical Document check for 'addr' tag -
...
-->
        ...
        <rule context="ext:asEmployment">
            ...
            <assert test="@classCode"
                >Error: Prescription Request - A8 Employment -
        ...
        <rule
            ...
            <!-- The tags and attributes of 'ext:asEntityIdentifier' are being tested in 'Prescription_Request_Global_Checks.sch'. -->
        ...
        <rule context = "cda:component/cda:section[not(descendant::cda:component/cda:section) and
            ...
            <assert test = "cda:title"
                ...
                Refer to Prescription_Request_CDA_Implementation_Guide_v0.5 and section 3.4.1 and 4.4.1 of the
        ...
        <rule context = "cda:observation/cda:text |
            ...
            <report test = "
                ...
                Check all 'cda:observation/cda:text' or 'cda:observation/cda:value' tags to find
                the incorrect 'mediaType' attribute. Refer to Prescription_Request_CDA_Implementation_Guide_v0.5 and section 3.4.1 and 4.4.1 of the
                Common_Conformance_Profile_for_Clinical_Documents_v1.3.</report>
        ...
        <rule context = "cda:observationMedia[translate(@ID, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')!='LOGO']">
            ...
            <assert test = "@ID">Error: Prescription Request -
                Global Clinical Document check for 'observationMedia' tag -
            ...
            <assert test = "not(@ID) or normalize-space(@ID) != ''">Error: Prescription Request -
            ...
            <assert test = "cda:value">Error: Prescription Request -
            ...
            <report test = "count(cda:value) > 1">Error: Prescription Request -
        ...
        <rule context = "cda:observationMedia[translate(@ID, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')='LOGO']/cda:value">
            ...
            <report test = "@representation and normalize-space(@representation)='B64'"
                ...
                Refer to Prescription_Request_CDA_Implementation_Guide_v0.5 and section 4.2.1 of the
...
-->
            ...
            <assert test = "cda:reference">Error: Prescription Request -
            ...
            <report test = "count(cda:reference) > 1">Error: Prescription Request -
                Global Clinical Document check for 'observationMedia/value' tag - The 'reference'
