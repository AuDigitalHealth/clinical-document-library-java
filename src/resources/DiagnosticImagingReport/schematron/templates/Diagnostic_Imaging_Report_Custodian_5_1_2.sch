...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Diagnostic_Imaging_Report_Custodian_5_1_2-errors"
        id="p-Diagnostic_Imaging_Report_Custodian_5_1_2-errors"
        see="#p-Diagnostic_Imaging_Report_Custodian_5_1_2-errors">


        <rule context="/cda:ClinicalDocument">

            <assert test="cda:custodian"
                >Error: Diagnostic Imaging Report - 5.1.2 Custodian -
                "custodian" -
