...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Diagnostic_Imaging_Report_ANZSCO_Checks_Revision1-errors"
        id="p-Diagnostic_Imaging_Report_ANZSCO_Checks_Revision1-errors"
        see="#p-Diagnostic_Imaging_Report_ANZSCO_Checks_Revision1-errors">
        ...
        <rule context="*[@codeSystem='2.16.840.1.113883.13.62']">            
            ...
            <assert test="number(@code) = floor(@code)">Error: Diagnostic Imaging Report - ANZSCO code
            ...
            <assert test="string-length(@code) = 6">Error: Diagnostic Imaging Report - ANZSCO code check for 
