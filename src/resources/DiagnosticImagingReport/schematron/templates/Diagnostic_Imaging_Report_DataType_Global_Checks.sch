...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- Diagnostic Imaging Report Clinical Document: DataType Global Checks -->
    ...
    <pattern name="p-Diagnostic_Imaging_Report_DataType_Global_Checks-errors"
        id="p-Diagnostic_Imaging_Report_DataType_Global_Checks-errors"
        see="#p-Diagnostic_Imaging_Report_DataType_Global_Checks-errors">
        ...
        <rule context="cda:value[@xsi:type = 'CS' or substring-after(normalize-space(@xsi:type), ':') = 'CS']">
            ...
            <assert test="@code">Error: Diagnostic Imaging Report -
                Global Clinical Document check for value datatype -
            ...
            <assert test="not(@code) or normalize-space(@code) != ''">Error: Diagnostic Imaging Report -
                Global Clinical Document check for value datatype -
                The 'value' tag 'code' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=CS' attribute to find the
        ...
        <rule context="cda:value[@xsi:type = 'INT' or substring-after(normalize-space(@xsi:type), ':') = 'INT']">
            ...
            <report test="@value and normalize-space(@value) = ''">Error: Diagnostic Imaging Report -
                Global Clinical Document check for value datatype -
                The 'value' tag 'value' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=INT' attribute to find the
                'value' attribute of missing value. Refer to section 'Reference List [NEHT2010c]' of the
        ...
        <rule context="cda:value[@xsi:type = 'PN' or substring-after(normalize-space(@xsi:type), ':') = 'PN']">
            ...
            <report test="cda:delimiter and normalize-space(cda:delimiter ) = ''"
                ...
                Check all 'cda:value' tags with 'xsi:type=PN' attribute to find the
                'delimiter' child tag have value missing. Refer to section 'Reference List [NEHT2010c]' of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            ...
            <assert test="not(cda:family) or normalize-space(cda:family) != ''"
                ...
                Check all 'cda:value' tags with 'xsi:type=PN' attribute to find the
                'family' child tag have value missing. Refer to section 'Reference List [NEHT2010c]' of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report test="cda:given and normalize-space(cda:given) = ''"
                ...
                Check all 'cda:value' tags with 'xsi:type=PN' attribute to find the
                'given' child tag have value missing. Refer to section 'Reference List [NEHT2010c]' of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:prefix and normalize-space(cda:prefix ) = ''"
                ...
                Check all 'cda:value' tags with 'xsi:type=PN' attribute to find the
                'prefix' child tag have value missing. Refer to section 'Reference List [NEHT2010c]' of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:suffix and normalize-space(cda:suffix) = ''"
                ...
                Check all 'cda:value' tags with 'xsi:type=PN' attribute to find the
                'suffix' child tag have value missing. Refer to section 'Reference List [NEHT2010c]' of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
        ...
        <rule context="cda:value[@xsi:type = 'PQ' or substring-after(normalize-space(@xsi:type), ':') = 'PQ']">
            ...
            <report test="@unit and normalize-space(@unit) = ''">Error: Diagnostic Imaging Report -
                Global Clinical Document check for value datatype -
            ...
            <report test="@unit and not(@value)">Error: Diagnostic Imaging Report -
                Global Clinical Document check for value datatype -
            ...
            <report test="@value and not(@unit)">Error: Diagnostic Imaging Report -
                Global Clinical Document check for value datatype -
        ...
        <rule context="cda:value[@xsi:type = 'IVL_PQ' or substring-after(normalize-space(@xsi:type), ':') = 'IVL_PQ']">
             ...
             <assert test="cda:low or cda:high or @nullFlavor"
                 >Error: Diagnostic Imaging Report - Global Clinical Document check for "cda:value" - The 'value' tag shall
                 ...
                 missing attribute(s) or child tag(s). Refer to section 'Reference List [NEHT2010c]' of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>                  
    
            <report test="@nullFlavor and normalize-space(@nullFlavor)=''">Error: Diagnostic Imaging Report - Global Clinical
            ...
            <report test="count(cda:low) > 1"
                ...
                Refer to section 'Reference List [NEHT2010c]' of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="cda:center"
                 >Error: Diagnostic Imaging Report - Global Clinical Document check for "cda:value" - The 'center' tag shall
                 not be present. Check all 'cda:value'
                 tags with 'xsi:type=IVL_PQ' attribute to find the
                 missing attribute(s) or child tag(s). Refer to section 'Reference List [NEHT2010c]' of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            
            <report test="cda:width"
                 >Error: Diagnostic Imaging Report - Global Clinical Document check for "cda:value" - The 'width' tag shall
                 not be present. Check all 'cda:value'
                 tags with 'xsi:type=IVL_PQ' attribute to find the
                 missing attribute(s) or child tag(s). Refer to section 'Reference List [NEHT2010c]' of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
        ...
        <rule context="cda:value[@xsi:type = 'IVL_PQ' or substring-after(normalize-space(@xsi:type), ':') = 'IVL_PQ']/cda:low | 
           ...
           <assert test="@nullFlavor or @value or @unit">Error: Diagnostic Imaging Report - Global Clinical
               ...
               Refer to section 'Reference List [NEHT2010c]' of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert> 
           ...
           <report test="@nullFlavor and normalize-space(@nullFlavor)=''">Error: Diagnostic Imaging Report - Global Clinical
            ...
            <report test="@value and normalize-space(@value)=''">Error: Diagnostic Imaging Report - Global Clinical
                Document check for "cda:value" - The 'value' tag's child tag 'value' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=IVL_PQ' attribute. Refer to section 'Reference List [NEHT2010c]' of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            
            <report test="@unit and normalize-space(@unit)=''">Error: Diagnostic Imaging Report - Global Clinical
                Document check for "cda:value" - The 'value' tag's child tag 'unit' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=IVL_PQ' attribute. Refer to section 'Reference List [NEHT2010c]' of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            
            <report test="@inclusive and normalize-space(@inclusive)=''">Error: Diagnostic Imaging Report - Global Clinical
