...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- Diagnostic Imaging Report Clinical Document: 3A Global Checks -->
    ...
    <pattern name="p-Diagnostic_Imaging_Report_3A_Global_Checks-errors"
        id="p-Diagnostic_Imaging_Report_3A_Global_Checks-errors"
        see="#p-Diagnostic_Imaging_Report_3A_Global_Checks-errors">
        ...
        <rule context="cda:targetSiteCode">
            ...
            <!-- This following asserts/reports test for code attributes as given in Section "7.1.1.1 targetSiteCode" of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0. -->
