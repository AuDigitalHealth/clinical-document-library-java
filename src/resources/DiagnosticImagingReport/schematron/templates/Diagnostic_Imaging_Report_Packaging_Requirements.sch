...
_________________________________________________________________________________________________________________________________________________________________________________________
                  ...
                  Generated          : 16/04/2015 2:59:37 PM
...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Diagnostic_Imaging_Report_Packaging_Requirements-errors"
        id="p-Diagnostic_Imaging_Report_Packaging_Requirements-errors"
        see="#p-Diagnostic_Imaging_Report_Packaging_Requirements-errors">
...
<rule  context="cda:text[cda:reference[@value][not(starts-with(@value, '#') or contains(@value, ':'))]]">
    ...
    <report test="@integrityCheckAlgorithm and normalize-space(@integrityCheckAlgorithm) = ''"
        >Error:  Diagnostic Imaging Report - Global Clinical Document check for *[child::*:reference] tag - The 'integrityCheckAlgorithm' tag shall
    ...
    <assert test="@integrityCheck">Error: Diagnostic Imaging Report - Global Clinical Document
        ...
        'integrityCheck' attribute missing. Refer to M 20 and M22 of 3.3.3 Conformance points of  CDA Package Version 1.0 and the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
