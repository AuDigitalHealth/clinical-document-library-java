...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Diagnostic_Imaging_Report_Entity_Identifier_Checks-errors"
        id="p-Diagnostic_Imaging_Report_Entity_Identifier_Checks-errors"
        see="#p-Diagnostic_Imaging_Report_Entity_Identifier_Checks-errors">
        ...
        <rule context="ext:asEntityIdentifier/ext:id">
           ...
           <report
            ...
            <report
                ...
                Identifier of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
