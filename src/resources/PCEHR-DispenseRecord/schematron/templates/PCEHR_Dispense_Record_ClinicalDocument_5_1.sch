...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Dispense_Record_ClinicalDocument_5_1-errors"
        id="p-PCEHR_Dispense_Record_ClinicalDocument_5_1-errors"
        see="#p-PCEHR_Dispense_Record_ClinicalDocument_5_1-errors">


        <rule context="/">

            <assert test="cda:ClinicalDocument"
                >Error: PCEHR Dispense Record - 5.1 ClinicalDocument  -
                "ClinicalDocument" -
        ...
        <rule context="/cda:ClinicalDocument/cda:code">
            ...
            <assert test="
                not(@code) or normalize-space(@code) = '' or @code = '100.16765'"
                >Error: PCEHR Dispense Record - 5.1 ClinicalDocument  -
                "ClinicalDocument/code" -
                The 'code' tag 'code' attribute shall contain the value '100.16765'.
                Refer to section 5.1 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <assert test="
                not(@displayName) or normalize-space(@displayName) = '' or translate(@displayName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ') = &quot;PCEHR DISPENSE RECORD&quot;"
                >Error: PCEHR Dispense Record - 5.1 ClinicalDocument  -
                "ClinicalDocument/code" -
                The 'code' tag 'displayName' attribute shall contain the value 'PCEHR Dispense Record'.
                Refer to section 5.1 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
