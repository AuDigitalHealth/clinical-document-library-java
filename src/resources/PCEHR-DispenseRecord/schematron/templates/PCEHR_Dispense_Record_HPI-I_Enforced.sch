...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Dispense_Record_HPI-I_Enforced-errors"
        id="p-PCEHR_Dispense_Record_HPI-I_Enforced-errors"
        see="#p-PCEHR_Dispense_Record_HPI-I_Enforced-errors">
