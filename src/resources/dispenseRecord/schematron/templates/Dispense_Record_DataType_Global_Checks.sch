...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- Dispense Record Clinical Document: DataType Global Checks -->
    ...
    <pattern name="p-Dispense_Record_DataType_Global_Checks-errors"
        id="p-Dispense_Record_DataType_Global_Checks-errors"
        see="#p-Dispense_Record_DataType_Global_Checks-errors">
        ...
        <rule context="cda:value[@xsi:type = 'CS' or substring-after(normalize-space(@xsi:type), ':') = 'CS']">
            ...
            <assert test="@code">Error: Dispense Record -
                Global Clinical Document check for value datatype -
            ...
            <assert test="not(@code) or normalize-space(@code) != ''">Error: Dispense Record -
                Global Clinical Document check for value datatype -
                The 'value' tag 'code' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=CS' attribute to find the
        ...
        <rule context="cda:value[@xsi:type = 'INT' or substring-after(normalize-space(@xsi:type), ':') = 'INT']">
            ...
            <report test="@value and normalize-space(@value) = ''">Error: Dispense Record -
                Global Clinical Document check for value datatype -
                The 'value' tag 'value' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=INT' attribute to find the
                'value' attribute of missing value. Refer to sections of the
        ...
        <rule context="cda:value[@xsi:type = 'PQ' or substring-after(normalize-space(@xsi:type), ':') = 'PQ']">
            ...
            <report test="@unit and normalize-space(@unit) = ''">Error: Dispense Record -
                Global Clinical Document check for value datatype -
            ...
            <report test="@unit and not(@value)">Error: Dispense Record -
                Global Clinical Document check for value datatype -
            ...
            <report test="@value and not(@unit)">Error: Dispense Record -
                Global Clinical Document check for value datatype -
        ...
        <rule context="cda:value[@xsi:type = 'IVL_PQ' or substring-after(normalize-space(@xsi:type), ':') = 'IVL_PQ']">
             ...
             <assert test="cda:low or cda:high or @nullFlavor"
                 >Error: Dispense Record - Global Clinical Document check for "cda:value" - The 'value' tag shall
                 ...
                 missing attribute(s) or child tag(s). Refer to sections of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013.</assert>                  
    
            <report test="@nullFlavor and normalize-space(@nullFlavor)=''">Error: Dispense Record - Global Clinical
            ...
            <report test="count(cda:low) > 1"
                ...
                Refer to sections of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013.</report>
            ...
            <report test="cda:center"
                 >Error: Dispense Record - Global Clinical Document check for "cda:value" - The 'center' tag shall
                 not be present. Check all 'cda:value'
                 tags with 'xsi:type=IVL_PQ' attribute to find the
                 missing attribute(s) or child tag(s). Refer to sections of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013.</report>
            
            <report test="cda:width"
                 >Error: Dispense Record - Global Clinical Document check for "cda:value" - The 'width' tag shall
                 not be present. Check all 'cda:value'
                 tags with 'xsi:type=IVL_PQ' attribute to find the
                 missing attribute(s) or child tag(s). Refer to sections of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013.</report>
        ...
        <rule context="cda:value[@xsi:type = 'IVL_PQ' or substring-after(normalize-space(@xsi:type), ':') = 'IVL_PQ']/cda:low | 
           ...
           <assert test="@nullFlavor or @value or @unit">Error: Dispense Record - Global Clinical
               ...
               Refer to sections of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013.</assert> 
           ...
           <report test="@nullFlavor and normalize-space(@nullFlavor)=''">Error: Dispense Record - Global Clinical
            ...
            <report test="@value and normalize-space(@value)=''">Error: Dispense Record - Global Clinical
                Document check for "cda:value" - The 'value' tag's child tag 'value' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=IVL_PQ' attribute. Refer to sections of the
                Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013.</report>
            
            <report test="@unit and normalize-space(@unit)=''">Error: Dispense Record - Global Clinical
                Document check for "cda:value" - The 'value' tag's child tag 'unit' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=IVL_PQ' attribute. Refer to sections of the
                Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013.</report>
            
            <report test="@inclusive and normalize-space(@inclusive)=''">Error: Dispense Record - Global Clinical
