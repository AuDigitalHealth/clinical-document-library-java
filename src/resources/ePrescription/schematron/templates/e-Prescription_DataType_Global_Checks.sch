    ...
    <pattern name="p-e-Prescription_DataType_Global_Checks-errors"
        ...
        <rule context="cda:value[@xsi:type = 'IVL_PQ' or substring-after(normalize-space(@xsi:type), ':') = 'IVL_PQ']">
             ...
             <assert test="cda:low or cda:high or @nullFlavor"
                 >Error: e-Prescription - Global Clinical Document check for "cda:value" - The 'value' tag shall
                 ...
                 missing attribute(s) or child tag(s). Refer to sections of the e-Prescription_CDA_Implementation_Guide_vATS 4888.3-2013.</assert>                  
    
            <report test="@nullFlavor and normalize-space(@nullFlavor)=''">Error: e-Prescription - Global Clinical
            ...
            <report test="count(cda:low) > 1"
                ...
                Refer to sections of the e-Prescription_CDA_Implementation_Guide_vATS 4888.3-2013.</report>
            ...
            <report test="cda:center"
                 >Error: e-Prescription - Global Clinical Document check for "cda:value" - The 'center' tag shall
                 not be present. Check all 'cda:value'
                 tags with 'xsi:type=IVL_PQ' attribute to find the
                 missing attribute(s) or child tag(s). Refer to sections of the e-Prescription_CDA_Implementation_Guide_vATS 4888.3-2013.</report>
            
            <report test="cda:width"
                 >Error: e-Prescription - Global Clinical Document check for "cda:value" - The 'width' tag shall
                 not be present. Check all 'cda:value'
                 tags with 'xsi:type=IVL_PQ' attribute to find the
                 missing attribute(s) or child tag(s). Refer to sections of the e-Prescription_CDA_Implementation_Guide_vATS 4888.3-2013.</report>
        ...
        <rule context="cda:value[@xsi:type = 'IVL_PQ' or substring-after(normalize-space(@xsi:type), ':') = 'IVL_PQ']/cda:low | 
           ...
           <assert test="@nullFlavor or @value or @unit">Error: e-Prescription - Global Clinical
               ...
               Refer to sections of the e-Prescription_CDA_Implementation_Guide_vATS 4888.3-2013.</assert> 
           ...
           <report test="@nullFlavor and normalize-space(@nullFlavor)=''">Error: e-Prescription - Global Clinical
            ...
            <report test="@value and normalize-space(@value)=''">Error: e-Prescription - Global Clinical
                Document check for "cda:value" - The 'value' tag's child tag 'value' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=IVL_PQ' attribute. Refer to sections of the
                e-Prescription_CDA_Implementation_Guide_vATS 4888.3-2013.</report>
            
            <report test="@unit and normalize-space(@unit)=''">Error: e-Prescription - Global Clinical
                Document check for "cda:value" - The 'value' tag's child tag 'unit' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=IVL_PQ' attribute. Refer to sections of the
                e-Prescription_CDA_Implementation_Guide_vATS 4888.3-2013.</report>
            
            <report test="@inclusive and normalize-space(@inclusive)=''">Error: e-Prescription - Global Clinical
