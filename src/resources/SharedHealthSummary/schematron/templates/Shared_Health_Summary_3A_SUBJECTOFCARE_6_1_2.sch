...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Shared_Health_Summary_3A_SUBJECTOFCARE_6_1_2-errors"
        id="p-Shared_Health_Summary_3A_SUBJECTOFCARE_6_1_2-errors"
        see="#p-Shared_Health_Summary_3A_SUBJECTOFCARE_6_1_2-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '102.16080']/cda:entry/cda:observation[cda:code/@code = '103.10243']/cda:id">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '102.16080']/cda:entry/cda:observation[cda:code/@code = '103.10243']/cda:value">
            ...
            <assert test="@displayName"
                >Error: Shared Health Summary - 6.1.2 SUBJECT OF CARE -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Source of Death Notification" -
                The 'value' tag 'displayName' attribute is missing.
                Refer to section 6.1.2 of the
                Shared_Health_Summary_CDA_Implementation_Guide_v1.4.</assert>
            ...
            <assert test="not(@code) or normalize-space(@code) = '' or
                ...
                document('TEMPLATE/VALDN/CDAValidate_Vocabs.xml', .)/systems/system [@codeSystemName = 'AS_5017-2006_Health_Care_Client_Source_of_Death_Notification']/code[
                    (@code = current()/@code) and (
                    translate(@displayName,  'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ') =
                    translate(current()/@displayName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'))]"
                >Error: Shared Health Summary - 6.1.2 SUBJECT OF CARE -
