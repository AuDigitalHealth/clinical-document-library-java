...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Prescription_Record_LegalAuthenticator_5_1_1_custom-errors"
        id="p-PCEHR_Prescription_Record_LegalAuthenticator_5_1_1_custom-errors"
        see="#p-PCEHR_Prescription_Record_LegalAuthenticator_5_1_1_custom-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:code">
            ...
            <report test="
                ...
                >Error: PCEHR Prescription Record - 5.1.1 LegalAuthenticator - "LegalAuthenticator"
                - The 'originalText' tag is missing for without code attribute present. Refer to
            ...
            <report test="
                ...
                @nullFlavor = 'OTH'"
                >Error: PCEHR Prescription Record - 5.1.1 LegalAuthenticator - "LegalAuthenticator"
                - The 'code' tag 'nullFlavor' attribute shall not contain the value 'OTH'. Refer to
                section 5.1.1 of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
        ...
        <rule context="/cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:assignedPerson">
            ...
            <assert test="ext:asEntityIdentifier">Error: PCEHR Prescription Record - 5.1.1 Legal
            ...
            <assert test="cda:name">Error: PCEHR Prescription Record - 5.1.1 Legal Authenticator -
            ...
            <report
                ...
                >Error: PCEHR Prescription Record - 5.1.1 Legal Authenticator - "legalAuthenticator /
                ...
                Authenticator of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
        ...
        <rule context="/cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:assignedPerson/ext:asEntityIdentifier">
            ...
            <report test="(ext:code/@code='EI') and not(ext:id/@assigningAuthorityName)">Error:
                PCEHR Prescription Record - 5.1.1 Legal Authenticator - "legalAuthenticator /
                assignedEntity / assignedPerson / Entity Identifier" - The 'asEntityIdentifier' tag
        ...
        <rule context="/cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:assignedPerson/ext:asEntityIdentifier/ext:id">            
            ...
            <report test="@nullFlavor">Error: PCEHR Prescription Record - 5.1.1 Legal Authenticator -
        ...
        <rule context="/cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:assignedPerson/ext:asEntityIdentifier/ext:code[@code='EI']">
            ...
            <assert test="@codeSystem">Error: PCEHR Prescription Record - 5.1.1 Legal Authenticator -
                "legalAuthenticator / assignedEntity / assignedPerson / Entity Identifier" - The
                'code' tag 'codeSystem' attribute is missing. Refer to section 3.4.10 Local
                identifier for a person of COMMON-ConformProfileClinDoc-v1.4 and section 5.1.1 Legal
                Authenticator of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <assert test="@codeSystemName">Error: PCEHR Prescription Record - 5.1.1 Legal Authenticator
                - "legalAuthenticator / assignedEntity / assignedPerson / Entity Identifier" - The
            ...
            <report test="@codeSystemName and normalize-space(@codeSystemName) = ''">Error: PCEHR
                Prescription Record - 5.1.1 Legal Authenticator - "legalAuthenticator / assignedEntity /
