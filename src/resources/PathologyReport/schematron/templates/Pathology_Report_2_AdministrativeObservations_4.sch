...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Pathology_Report_2_AdministrativeObservations_4-errors"
        id="p-Pathology_Report_2_AdministrativeObservations_4-errors"
        see="#p-Pathology_Report_2_AdministrativeObservations_4-errors">


        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody">

            <report test="count(cda:component[cda:section/cda:code/@code = '102.16080']) > 1"
                >Error: Pathology Report - 4 Administrative Observations -
