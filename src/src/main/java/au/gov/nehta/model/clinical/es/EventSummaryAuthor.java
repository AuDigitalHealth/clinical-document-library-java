...
/**
 * Document author for a event summary
 */
public interface EventSummaryAuthor {
    /**
     ...
     */
    DateTime getParticipationPeriod();
     ...
     *
     * <p>A required CDA element. This is a technical identifier that is used for system purposes such
     * as matching. If a suitable internal key is not available, a UUID MAY be used.
     */
    String getID();

    // TODO Validation Required - Several here. See (.net) IParticipationDocumentAuthor
}
