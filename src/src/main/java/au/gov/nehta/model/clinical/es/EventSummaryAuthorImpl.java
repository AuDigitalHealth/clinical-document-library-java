...
public class EventSummaryAuthorImpl implements EventSummaryAuthor {
  private Coded role;
  private DateTime participationPeriod;
  ...
  public void setEntitlements(List<? extends Entitlement> entitlements) {
   ...
   *
   * <p>this is a required CDA element, a technical identifier that is used for system purposes such
