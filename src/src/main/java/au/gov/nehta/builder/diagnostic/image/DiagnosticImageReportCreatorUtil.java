...
public class DiagnosticImageReportCreatorUtil extends DocumentCreatorUtil {
    ...
    public static StrucDocText getImageExaminationResultNarrativeBlock(ImagingExaminationResult imageResult) {
        ...
        add(body,
        		...
        		cell(print(imageResult.getAnatomicalRegion().getRegionCode())),
	...
	private static StrucDocTable getSiteNarrative(List<AnatomicalSite> sites) {
        ...
        for(AnatomicalSite site:sites){
        	add(body, print(site.getSpecificLocationName())+" "+safe(site.getDescription()), print(site.getSpecificLocationSide()));
        }
	...
	public static StrucDocText diagnosticImageSection(DiagnosticImageReportContent content) {
        ...
        JAXBElement<StrucDocContent> link = link(rd.getTestResultsRepresentation().getFileName(), rd.getReportTitle());
