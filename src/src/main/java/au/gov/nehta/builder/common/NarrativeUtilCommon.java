...
public class NarrativeUtilCommon {
  ...
  public static final StrucDocText DIAGNOSTIC_INVESTIGATIONS_SECTION_TEXT =
      NarrativeUtilCommon.getEmptyStrucDocTextParagraph("This section " +
          "contains the following subsections: Pathology Test Result, Imaging Examination " +
          "Result and Requested Service(s).");
  public static final String EVENT_SECTION_TEXT =
      "This section contains the following subsections: Clinical Summary,"
          + " Problems/Diagnoses This Visit, Procedures and Diagnostic Investigations.";
  public static final String HEALTH_PROFILE_SECTION_TEXT =
      "This section contains the following subsections: "
          + "Adverse Reactions and Alerts.";
  public static final String PLAN_SECTION_TEXT =
          "This section contains the following subsections: "
  ...
  public static final StrucDocText MEDICATIONS_SECTION_TEXT =
      NarrativeUtilCommon.getEmptyStrucDocTextParagraph("This section contains the "
          + "following subsections: Current Medications On Discharge and Ceased Medications.");
