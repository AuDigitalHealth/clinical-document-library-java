...
<schema xmlns="http://www.ascc.net/xml/schematron">
	...
	<pattern name="p-PCEHR_Prescription_Record_ClinicalDocument_5_1_custom-errors"
		id="p-PCEHR_Prescription_Record_ClinicalDocument_5_1_custom-errors"
		see="#p-PCEHR_Prescription_Record_ClinicalDocument_5_1_custom-errors">
	    ...
	    <!--We require the combination of @root = '1.2.36.1.2001.1001.100.1002.170' and @extension='1.0' AND
		...
		<rule context="/cda:ClinicalDocument">
			...
			<assert
				test="count(cda:templateId[@root = '1.2.36.1.2001.1001.100.1002.170' and @extension='1.0'])>0"
				>Error: PCEHR Prescription Record - 5.1 Clinical Document - "ClinicalDocument / templateId" - The
			...
			<assert
				...
				>Error: PCEHR Prescription Record - 5.1 Clinical Document - "ClinicalDocument /
    ...
    <!-- 18/10 - JIRA ID - CCAS-74 :   Need to test for "en-AU" or "en" values-->
	  ...
	  <rule context="/cda:ClinicalDocument/cda:languageCode">
            ...
            <assert test="@code">Error: PCEHR Prescription Record - 5.1 Clinical Document - "ClinicalDocument /
                languageCode" - The 'languageCode' tag 'code' attribute is missing. Refer to section 5.1 of the
			    PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>

            <assert
                test="@code = 'en-AU' or @code='en'"
                >Error: PCEHR Prescription Record - 5.1 ClinicalDocument  -
				"ClinicalDocument/ languageCode" - The
                ...
                'en-AU' or 'en'. Refer to section 5.1 of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>
