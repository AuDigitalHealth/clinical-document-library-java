...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Prescription_Record_Entity_Identifier_Checks-errors"
        id="p-PCEHR_Prescription_Record_Entity_Identifier_Checks-errors"
        see="#p-PCEHR_Prescription_Record_Entity_Identifier_Checks-errors">
        ...
        <rule context="ext:asEntityIdentifier/ext:id">
            ...
            <report
                ...
                Identifier of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
