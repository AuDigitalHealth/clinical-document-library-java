...
<!ENTITY ent-PCEHR_Prescription_Record_2_AdministrativeObservations_4                            	SYSTEM 'templates/PCEHR_Prescription_Record_2_AdministrativeObservations_4.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_2_Global_Code_Checks_custom                               	SYSTEM 'templates/PCEHR_Prescription_Record_2_Global_Code_Checks_custom.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_2_PCEHRPrescriptionRecord_7_1                             	SYSTEM 'templates/PCEHR_Prescription_Record_2_PCEHRPrescriptionRecord_7_1.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_2_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1            	SYSTEM 'templates/PCEHR_Prescription_Record_2_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_3A_Global_Code_Checks_custom                              	SYSTEM 'templates/PCEHR_Prescription_Record_3A_Global_Code_Checks_custom.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_3A_Prescriber_6_1_2                                       	SYSTEM 'templates/PCEHR_Prescription_Record_3A_Prescriber_6_1_2.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_3A_Prescriber_6_1_2_custom                                	SYSTEM 'templates/PCEHR_Prescription_Record_3A_Prescriber_6_1_2_custom.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_3A_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1           	SYSTEM 'templates/PCEHR_Prescription_Record_3A_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_3A_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1_custom    	SYSTEM 'templates/PCEHR_Prescription_Record_3A_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1_custom.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_3A_SubjectofCare_6_1_1                                    	SYSTEM 'templates/PCEHR_Prescription_Record_3A_SubjectofCare_6_1_1.ent'>
<!ENTITY ent-PCEHR_Prescription_Record_3A_SubjectofCare_6_1_1_custom                             	SYSTEM 'templates/PCEHR_Prescription_Record_3A_SubjectofCare_6_1_1_custom.ent'>
...
<title>Schematron schema for validating 3B conformance to PCEHR Prescription Record CDA documents</title>
...
<phase id = "errors">
	...
	<active pattern = "p-PCEHR_Prescription_Record_2_AdministrativeObservations_4-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_2_Global_Code_Checks_custom-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_2_PCEHRPrescriptionRecord_7_1-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_2_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_3A_Global_Code_Checks_custom-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_3A_Prescriber_6_1_2-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_3A_Prescriber_6_1_2_custom-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_3A_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_3A_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1_custom-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_3A_SubjectofCare_6_1_1-errors"/>
	<active pattern = "p-PCEHR_Prescription_Record_3A_SubjectofCare_6_1_1_custom-errors"/>
	...
	&ent-PCEHR_Prescription_Record_2_AdministrativeObservations_4;
	&ent-PCEHR_Prescription_Record_2_Global_Code_Checks_custom;
	&ent-PCEHR_Prescription_Record_2_PCEHRPrescriptionRecord_7_1;
	&ent-PCEHR_Prescription_Record_2_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1;
	&ent-PCEHR_Prescription_Record_3A_Global_Code_Checks_custom;
	&ent-PCEHR_Prescription_Record_3A_Prescriber_6_1_2;
	&ent-PCEHR_Prescription_Record_3A_Prescriber_6_1_2_custom;
	&ent-PCEHR_Prescription_Record_3A_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1;
	&ent-PCEHR_Prescription_Record_3A_PrescriptionItem_MEDICATIONINSTRUCTION_7_1_1_custom;
	&ent-PCEHR_Prescription_Record_3A_SubjectofCare_6_1_1;
	&ent-PCEHR_Prescription_Record_3A_SubjectofCare_6_1_1_custom;
