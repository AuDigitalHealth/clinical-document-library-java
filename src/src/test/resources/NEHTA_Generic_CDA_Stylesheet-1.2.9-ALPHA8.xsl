...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:variable name="NEHTA_GENERIC_CDA_STYLESHEET_VERSION">1.2.9-ALPHA8</xsl:variable>
    ...
    <xsl:variable name="NEHTA_ADVANCE_CARE_DIRECTIVE_CUSTODIAN_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Advance Care Directive Custodian</xsl:variable>
