...
<!--
	...
	- Updated document type names:
	    ...
	    - "Australian Childhood Immunization Register Record" to "Australian Childhood Immunization Register"
	    - "Advance Care Directive Custodian Record" to "Advance Care Directive Custodian"
	...
	- Added rendering of Requester participants in Pathology Report and Diagnostic Image Report 
...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:param name="administrativeObservationsSectionDisplay">false</xsl:param>
    ...
    <xsl:variable name="NEHTA_GENERIC_CDA_STYLESHEET_VERSION">1.2.9-ALPHA7</xsl:variable>
    ...
    <xsl:variable name="NEHTA_ADVANCE_CARE_DIRECTIVE_CUSTODIAN_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Advanced Care Directive Custodian</xsl:variable>
