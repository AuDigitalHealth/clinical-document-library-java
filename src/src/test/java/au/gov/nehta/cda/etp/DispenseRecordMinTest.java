...
public class DispenseRecordMinTest  extends Base {
    ...
    @Test @Ignore
    public void test_MIN_DispenseRecord() throws ParserConfigurationException, JAXBException, SchematronValidationException{
        generateMin();
    ...
    public void generateMin() throws ParserConfigurationException, JAXBException, SchematronValidationException {
        // Setup context
        // Subject Of Care
        ...
        SubjectOfCareParticipant subjectOfCareParticipant =new SubjectOfCareParticipantImpl( new ArrayList<AsEntityIdentifier>(0), subjectOfCareAddress, subjectOfCarePerson );
...
//      SubjectOfCareParticipation subjectOfCareParticipation = new SubjectOfCareParticipationImpl( subjectOfCareParticipationType,  subjectOfCareParticipant );
        ...
        Telecom dispensingOrganisationEmail =  new TelecomImpl( TelecomMedium.EMAIL, "info@londondrugs.com.au" );
        Telecom dispensingOrganisationTel = new TelecomImpl( "02123456789" );
        List<Telecom> electronicCommunicationDetailList = Arrays.asList( dispensingOrganisationEmail,dispensingOrganisationTel );
        ...
        Person authenticatorPerson = PersonImpl.getInstance( authenticatorHPII, PersonNameImpl.createPersonName("Black") );
