...
public class EPrescriptionMaxTest  extends Base{
    ...
    private static final String DOCUMENT_FILE_NAME = TEST_GENERATION+"eprescription-max.xml";
    
    
    @Test @Ignore
    public void test_MAX_EPrescriptionCreation() throws ParserConfigurationException, JAXBException, SchemaValidationException, SchematronValidationException, IOException, ParseException, URISyntaxException {
        generateMax();
    ...
    public void generateMax() throws IOException, ParserConfigurationException, JAXBException, ParseException, SchematronValidationException {
		...
		List<Telecom> electronicCommunicationDetailList = Arrays.asList( prescriberOrganisationEmail,prescriberOrganisationTelephone );
        ...
        */
		...
		PreciseDate weightObservationTime = new PrecisionDate(Precision.DAY,  System.currentTimeMillis() );
		BodyWeight weightObservation = new BodyWeightImpl( bodyWeight,	weightObservationTime );
		
		String height = "180";
		PreciseDate heightObservationTime = new PrecisionDate(Precision.DAY, System.currentTimeMillis() );
		...
		LegalAuthenticator cdaLegalAuthenticator = LegalAuthenticatorImpl.getInstance( new DateTime(), cdaLegalAuthenticatorAssignedEntity );
		...
		Telecom custodianEmail = new TelecomImpl( TelecomMedium.EMAIL, "example@custodian.com.au", TelecomUse.BUSINESS_AND_PERSONAL );
