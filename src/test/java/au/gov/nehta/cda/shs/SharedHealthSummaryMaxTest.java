  ...
  private void generateMax() throws Exception {
    ...
    ProblemDiagnosis problem4 =
        new ProblemDiagnosisImpl(
            ...
            new PrecisionDate(Precision.DAY, new DateTime("2014-05-30")),
            new PrecisionDate(Precision.DAY, new DateTime("2014-06-30")),
    ...
    UncatagorisedMedicalHistoryItem item1 =
        new UncatagorisedMedicalHistoryItemImpl(
            "A descripition of another medical history item",
            time,
    ...
    UncatagorisedMedicalHistoryItem item4 =
        new UncatagorisedMedicalHistoryItemImpl("Vitamin C dietary suplement", null, null);
