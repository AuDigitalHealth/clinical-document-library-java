...
public class TestHelper {
    ...
    public static LegalAuthenticator getLegalAuthenticator(ZonedDateTime now) {
        // *******************************
        // ***** Legal Authenticator *****
        // *******************************
    ...
    public static SubjectOfCareParticipant getSubjectOfCareParticipant() {
        ...
        subjectEntitlement.setEntitlementValidityDuration(RestrictedTimeInterval
                        .getHighInstance(new PrecisionDate(Precision.DAY, ZonedDateTime.now().plusYears(1)))
    ...
    public static SharedHealthSummaryAuthor getSharedHealthSummaryAuthor(ZonedDateTime now) {
        // ******************
        // ***** AUTHOR *****
        // ******************
    ...
    public static SubjectOfCareParticipant getSubjectOfCareParticipantFemale() {
        ...
        ZonedDateTime dob = LocalDate.of(1976, 8, 28).atStartOfDay(ZoneId.systemDefault());
     ...
     */
    public static DocumentAuthor getDocumentAuthor(ZonedDateTime now) {
        Coded occupation = ANZSCO_1ED_2006.GENERAL_MEDICAL_PRACTITIONER;
    ...
    public static ServiceProvider getServiceProviderIndividual() {
        ...
        personHealthcareProvider
                .setDateOfBirth(new PrecisionDate(Precision.DAY, LocalDate.of(1970, 11, 11).atStartOfDay(ZoneId.systemDefault())));
    ...
    public static OtherTestResult getOtherTestResultWithContent() {
        ...
        return new OtherTestResultImpl(new CodeImpl() {{
            setOriginalText("Report Name");
                ...
                "Final"), new PrecisionDate(Precision.DAY, LocalDate.of(2017, 1, 1).atStartOfDay(ZoneId.systemDefault())), reportContent);
    }
    ...
    private static RequestedService getRequestedService(ServiceProvider serviceProvider,
        ...
        if (eventType == EventTypes.EVENT) {
            requestedService.setRequestedDateTime(
                    new PrecisionDate(Precision.DAY, LocalDate.of(2012, 12, 1).atStartOfDay(ZoneId.systemDefault())));
        } else {
        ...
        requestedService.setRequestedServiceDateTime(
                new PrecisionDate(Precision.DAY, LocalDate.of(2015, 1, 22).atStartOfDay(ZoneId.systemDefault())));
