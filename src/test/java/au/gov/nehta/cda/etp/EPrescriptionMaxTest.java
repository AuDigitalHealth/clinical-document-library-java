...
public class EPrescriptionMaxTest extends Base {
    ...
    private static final String SCHEMATRON_TEMPLATE_PATH = "src/test/resources/ePrescription";
    ...
    public void generateMax()
        ...
        */
        ...
        LegalAuthenticator cdaLegalAuthenticator = LegalAuthenticatorImpl
                .getInstance(ZonedDateTime.now(), cdaLegalAuthenticatorAssignedEntity);
