...
public class PrescriptionRequestMinTest extends Base {
    ...
    public void test_MIN_PrescriptionRequestCreation() {
        ...
        AddressContext subjectOfCareAddress = new AddressContextImpl(socAddress,
        ...
        SubjectOfCareDemographicData socData = new SubjectOfCareDemographicDataImpl(Sex.MALE,
                subjectOfCareDateOfBirthDetail);
        socData.setBirthPlurality(5);
        socData.setBirthOrder(2);
        int age = 35;
        socData.setAgeAccurate(true);
        socData.setAgeInYears(age);
        socData.setIndigenousStatus(
                IndigenousStatus.NEITHER__ABORIGINAL_NOR_TORRES_STRAIT_ISLANDER_ORIGIN);
        ...
        SubjectOfCareParticipant subjectOfCareParticipant = new SubjectOfCareParticipantImpl(
                Collections.singletonList(ihi), subjectOfCareAddress, subjectOfCarePerson);
        ...
        Telecom socEmail =
                new TelecomImpl(TelecomMedium.EMAIL, "frank.harding@electronichealth.net.au",
                        TelecomUse.PERSONAL);
...
//		SubjectOfCareParticipation subjectOfCareParticipation = new SubjectOfCareParticipationImpl( subjectOfCareParticipationType, subjectOfCareParticipant );
        ...
        List<Telecom> electronicCommunicationDetailList = Collections.singletonList(dispensingOrganisationTel);
...
//		Occupation prescriberOccupation = ParticipationFactory.createOccupation( ANZSCO_1ED_2006.GENERAL_MEDICAL_PRACTITIONER );
        ...
        List<Telecom> prescriberOrgTelecoms = Collections.singletonList(prescriberOrgTel);
        ...
        ZonedDateTime recipientDateOfBirth = LocalDate.of(1982, 11, 28).atStartOfDay(ZoneId.systemDefault());
...
//        intervalBetweenRepeats.setNarrative( "3 weeks" ); //a text description of this time quantity
        ...
        */
        ...
        ZonedDateTime prescriberInstructionTime = ZonedDateTime.now();
        ...
        CustodianOrganization custodianOrganization =
                CustodianOrganizationImpl.getInstance(Collections.singletonList(id),
                        custodianHPIO);
