...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Prescription_Custodian_6_4-errors"
        id="p-e-Prescription_Custodian_6_4-errors"
        see="#p-e-Prescription_Custodian_6_4-errors">


        <rule context="/cda:ClinicalDocument">

            <assert test="cda:custodian"
                >Error: e-Prescription - 6.4 Custodian -
                "custodian" -
