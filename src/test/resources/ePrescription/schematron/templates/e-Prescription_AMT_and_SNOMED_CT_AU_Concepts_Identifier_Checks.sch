...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Prescription_AMT_and_SNOMED_CT_AU_Concepts_Identifier_Checks-errors"
        id="p-e-Prescription_AMT_and_SNOMED_CT_AU_Concepts_Identifier_Checks-errors"
        see="#p-e-Prescription_AMT_and_SNOMED_CT_AU_Concepts_Identifier_Checks-errors">
        ...
        <rule
            ...
            <report test="starts-with(@code, '0')">Error: e-Prescription - Global Clinical Document
                ...
                the e-Prescription_CDA_Implementation_Guide_v0.3 and
            ...
            <assert test="number(@code) &gt;= 100001">Error: e-Prescription - Global Clinical
                Document check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
            ...
            <assert test="number(@code) &lt;= 999999999999999999">Error: e-Prescription - Global
                ...
                attribute(s). Refer to section e-Prescription_CDA_Implementation_Guide_v0.3 of the
                8.1 and AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>

            <assert test="normalize-space(@code) = @code">Error: e-Prescription - Global Clinical
                Document check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
                ...
                to section 8.1 of the e-Prescription_CDA_Implementation_Guide_v0.3 and
                AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>
            ...
            <assert test="number(@code) = floor(@code)">Error: e-Prescription - Global Clinical
                Document check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
