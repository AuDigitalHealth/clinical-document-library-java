...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Prescription_Entity_Identifier_Checks-errors"
        id="p-e-Prescription_Entity_Identifier_Checks-errors"
        see="#p-e-Prescription_Entity_Identifier_Checks-errors">
        ...
        <rule context="ext:asEntityIdentifier/ext:id">
            ...
            <report
                ...
                the e-Prescription_CDA_Implementation_Guide_v0.3.</report>
            ...
            <report
                ...
                Identifier of the e-Prescription_CDA_Implementation_Guide_v0.3.</report>
