...
_________________________________________________________________________________________________________________________________________________________________________________________
                  ...
                  Generated          : 8/08/2013 2:03:29 PM
...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Prescription_2_AdministrativeObservations_5-errors"
        id="p-e-Prescription_2_AdministrativeObservations_5-errors"
        see="#p-e-Prescription_2_AdministrativeObservations_5-errors">


        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody">

            <report test="count(cda:component[cda:section/cda:code/@code = '102.16080']) > 1"
                >Error: e-Prescription - 5 Administrative Observations -
