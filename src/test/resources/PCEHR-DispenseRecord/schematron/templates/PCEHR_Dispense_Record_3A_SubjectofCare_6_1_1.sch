...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Dispense_Record_3A_SubjectofCare_6_1_1-errors"
        id="p-PCEHR_Dispense_Record_3A_SubjectofCare_6_1_1-errors"
        see="#p-PCEHR_Dispense_Record_3A_SubjectofCare_6_1_1-errors">
        ...
        <rule context="cda:code[@code = '103.16233']">
            ...
            <assert test="
                not(@displayName) or normalize-space(@displayName) = '' or translate(@displayName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ') = &quot;DATE OF BIRTH IS CALCULATED FROM AGE&quot;"
                >Error: PCEHR Dispense Record - 6.1.1 Subject of Care -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Date of Birth Detail / Date of Birth is Calculated From Age" -
        ...
        <rule context="cda:code[@code = '102.16234']">
            ...
            <assert test="
                not(@displayName) or normalize-space(@displayName) = '' or translate(@displayName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ') = &quot;DATE OF BIRTH ACCURACY INDICATOR&quot;"
                >Error: PCEHR Dispense Record - 6.1.1 Subject of Care -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Date of Birth Detail / Date of Birth Accuracy Indicator" -
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '102.16080']/cda:entry/cda:observation[cda:code/@code = '102.16234']/cda:value">
            ...
            <assert test="
                not(@xsi:type) or normalize-space(@xsi:type) = '' or @xsi:type = 'CS'"
                >Error: PCEHR Dispense Record - 6.1.1 Subject of Care -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Date of Birth Detail / Date of Birth Accuracy Indicator" -
        ...
        <rule context="cda:code[@code = '103.20109']">
            ...
            <assert test="
                not(@displayName) or normalize-space(@displayName) = '' or translate(@displayName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ') = &quot;AGE&quot;"
                >Error: PCEHR Dispense Record - 6.1.1 Subject of Care -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Age Detail / Age" -
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '102.16080']/cda:entry/cda:observation[cda:code/@code = '103.20109']/cda:value">
            ...
            <assert test="
                not(@xsi:type) or normalize-space(@xsi:type) = '' or @xsi:type = 'PQ'"
                >Error: PCEHR Dispense Record - 6.1.1 Subject of Care -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Age Detail / Age" -
        ...
        <rule context="cda:code[@code = '103.16279']">
            ...
            <assert test="
                not(@displayName) or normalize-space(@displayName) = '' or translate(@displayName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ') = &quot;AGE ACCURACY INDICATOR&quot;"
                >Error: PCEHR Dispense Record - 6.1.1 Subject of Care -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Age Detail / Age Accuracy Indicator" -
        ...
        <rule context="cda:code[@code = '103.16249']">
            ...
            <assert test="
                not(@displayName) or normalize-space(@displayName) = '' or translate(@displayName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ') = &quot;BIRTH PLURALITY&quot;"
                >Error: PCEHR Dispense Record - 6.1.1 Subject of Care -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Birth Plurality" -
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '102.16080']/cda:entry/cda:observation[cda:code/@code = '103.16249']/cda:value">
            ...
            <assert test="
                not(@xsi:type) or normalize-space(@xsi:type) = '' or @xsi:type = 'INT'"
                >Error: PCEHR Dispense Record - 6.1.1 Subject of Care -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Birth Plurality" -
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '102.16210']/ext:coverage2[ext:entitlement/ext:participant/@typeCode = 'BEN']">
        ...
        <rule context="ext:participant[@typeCode = 'BEN']">
            ...
            <assert test="
                ...
                count(/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code='102.16210']/ext:coverage2/ext:entitlement/ext:participant[@typeCode='BEN'])"
                >Error: PCEHR Dispense Record - 6.1.1 Subject of Care -
                "Subject of Care / Participant / Entitlement" -
                The '/ClinicalDocument/component/structuredBody/component/section[code/@code = '102.16210']/coverage2/entitlement/participant[@typeCode = 'BEN']' path -
                1 or more tags are missing.
                Refer to section 6.1.1 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</assert>
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '102.16210']/ext:coverage2/ext:entitlement/ext:participant[@typeCode = 'BEN']/ext:participantRole">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '102.16210']/ext:coverage2/ext:entitlement/ext:participant[@typeCode = 'BEN']/ext:participantRole/ext:id">
