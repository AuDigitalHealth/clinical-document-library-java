...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Dispense_Record_Dispenser_6_1_2_custom-errors"
        id="p-PCEHR_Dispense_Record_Dispenser_6_1_2_custom-errors"
        see="#p-PCEHR_Dispense_Record_Dispenser_6_1_2_custom-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:assignedPerson/ext:asQualifications/ext:code">
            ...
            <report test="
                ...
                not(cda:originalText)"
                >Error: PCEHR Dispense Record - 6.1.2 Dispenser -
                "Dispenser / Participant / Qualification" -
                The 'originalText' tag is missing for without code attribute present.
                Refer to section 6.1.2 of the
                PCEHR_Dispense_Record_CDA_Implementation_Guide_v1.0.</report>
