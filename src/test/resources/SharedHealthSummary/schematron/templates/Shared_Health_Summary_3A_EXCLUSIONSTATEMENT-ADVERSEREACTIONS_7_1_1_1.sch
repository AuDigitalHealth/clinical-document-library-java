...
_________________________________________________________________________________________________________________________________________________________________________________________
                  ...
                  Generated          : 18/02/2015 1:23:37 PM
...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Shared_Health_Summary_3A_EXCLUSIONSTATEMENT-ADVERSEREACTIONS_7_1_1_1-errors"
        id="p-Shared_Health_Summary_3A_EXCLUSIONSTATEMENT-ADVERSEREACTIONS_7_1_1_1-errors"
        see="#p-Shared_Health_Summary_3A_EXCLUSIONSTATEMENT-ADVERSEREACTIONS_7_1_1_1-errors">


        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.20113']">

            <report test="count(cda:entry[cda:observation/cda:code/@code = '103.16302.120.1.1']) > 1"
                >Error: Shared Health Summary - 7.1.1.1 EXCLUSION STATEMENT - ADVERSE REACTIONS -
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.20113']/cda:entry[cda:observation/cda:code/@code = '103.16302.120.1.1']">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.20113']/cda:entry/cda:observation[cda:code/@code = '103.16302.120.1.1']/cda:id">
        ...
        <rule context="cda:code[@code = '103.16302.120.1.1']">

            <assert test="
                count(/cda:ClinicalDocument//cda:code[@code = '103.16302.120.1.1']) =
                count(/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code='101.20113']/cda:entry/cda:observation/cda:code[@code='103.16302.120.1.1'])"
                >Error: Shared Health Summary - 7.1.1.1 EXCLUSION STATEMENT - ADVERSE REACTIONS -
                "EXCLUSION STATEMENT - ADVERSE REACTIONS / Global Statement" -
                The '/ClinicalDocument/component/structuredBody/component/section[code/@code = '101.20113']/entry/observation/code[@code = '103.16302.120.1.1']' path -
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.20113']/cda:entry/cda:observation[cda:code/@code = '103.16302.120.1.1']/cda:value">
