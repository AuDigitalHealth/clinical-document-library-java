...
_________________________________________________________________________________________________________________________________________________________________________________________
                  ...
                  Generated          : 19/02/2015 3:07:19 PM

                  Product            : Shared Health Summary
                  Release            : CDA_Implementation_Guide_v1.0
                  IG Guide Reference : 7.1.3.4
                  IG Guide Title     : EXCLUSION STATEMENT - PROCEDURES
...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Shared_Health_Summary_3A_EXCLUSIONSTATEMENT-PROCEDURES_7_1_3_4-errors"
        id="p-Shared_Health_Summary_3A_EXCLUSIONSTATEMENT-PROCEDURES_7_1_3_4-errors"
        see="#p-Shared_Health_Summary_3A_EXCLUSIONSTATEMENT-PROCEDURES_7_1_3_4-errors">


        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16117']">

            <report test="count(cda:entry[cda:observation/cda:code/@code = '103.16302.120.1.4']) > 1"
                >Error: Shared Health Summary - 7.1.3.4 EXCLUSION STATEMENT - PROCEDURES -
                "Exclusion Statement - Procedures / Global Statement" -
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16117']/cda:entry[cda:observation/cda:code/@code = '103.16302.120.1.4']">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16117']/cda:entry/cda:observation[cda:code/@code = '103.16302.120.1.4']/cda:id">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16117']/cda:entry/cda:observation[cda:code/@code = '103.16302.120.1.4']/cda:value">
