...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Shared_Health_Summary_Global_Checks_Exceptions_Option_04-errors"
        id="p-Shared_Health_Summary_Global_Checks_Exceptions_Option_04-errors"
        see="#p-Shared_Health_Summary_Global_Checks_Exceptions_Option_04-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:addr">    
                ...
                <report test="@nullFlavor and normalize-space(@nullFlavor) != '' and @nullFlavor != 'NA' and @nullFlavor != 'UNK' and @nullFlavor != 'MSK'"
                 >Error: Shared Health Summary - SSSSSSSS SUBJECT OF CARE -
                 "Subject of Care" -  The 'addr' tag 'nullFlavor' attribute shall contain the value 'NA' or 'UNK' or 'MSK'.
                  Refer to section SSSSSSSS and 8.6 of the
                 Shared_Health_Summary_CDA_Implementation_Guide_v1.4.</report>
