...
_________________________________________________________________________________________________________________________________________________________________________________________
                  ...
                  Generated          : 12/02/2015 9:55:24 AM
...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Shared_Health_Summary_mediaType_Additional_Checks-errors"
        id="p-Shared_Health_Summary_mediaType_Additional_Checks-errors"
        see="#p-Shared_Health_Summary_mediaType_Additional_Checks-errors">

                
        <rule context="*[cda:reference[@value][not(starts-with(@value, '#'))]]"> 
            
            <assert test="@mediaType">Error: Shared Health Summary - Global Clinical Document
                ...
                'mediaType' attribute missing. Refer to
                Shared_Health_Summary_CDA_Implementation_Guide_v1.4 and 023741 MIME types
                allowed as attachments of the
                Common_Conformance_Profile_for_Clinical_Documents_v1.6.</assert>
            
            <report test="@xsi:type and normalize-space(@xsi:type) = ''">Error: Shared Health Summary - 
                ...
                to find the tag with blank 'xsi:type' attribute value. Refer to
                Shared_Health_Summary_CDA_Implementation_Guide_v1.4 and 023741 MIME types
                allowed as attachments of the
                Common_Conformance_Profile_for_Clinical_Documents_v1.6.</report>
            
            <report test="count(cda:reference) > 1">Error: Shared Health Summary - Global
                ...
                'reference' tag. Refer to Shared_Health_Summary_CDA_Implementation_Guide_v1.4
            ...
            <assert
                ...
                *[child::*:reference] tag - The 'mediaType' attribute is missing for having
                ...
                attribute missing. Refer to Shared_Health_Summary_CDA_Implementation_Guide_v1.4
                and 023741 MIME types allowed as attachments of the
                Common_Conformance_Profile_for_Clinical_Documents_v1.6.</assert>
            
            <report test="@mediaType and normalize-space(@mediaType) = ''">Error: Shared Health Summary - 
                Global Clinical Document check for *[child::*:reference] tag - The
                'mediaType' attribute shall contain a value. Check all parent tags of reference tag
                to find the 'mediaType' attribute of missing value. Refer to
                Shared_Health_Summary_CDA_Implementation_Guide_v1.4 and 023741 MIME types
                allowed as attachments of the
                Common_Conformance_Profile_for_Clinical_Documents_v1.6.</report>
            ...
            <report
                ...
                *[child::*:reference] tag - The 'mediaType' attribute shall contain a value. Check
                all parent tags of reference tag to find the incorrect 'mediaType' attribute. Refer
                to Shared_Health_Summary_CDA_Implementation_Guide_v1.4 and 023741 MIME types
                allowed as attachments of the
                Common_Conformance_Profile_for_Clinical_Documents_v1.6.</report>
            ...
            <assert
                ...
                Error: Shared Health Summary - Global Clinical Document check for *[child::*:reference] tag - 
                The 'mediaType' attribute shall match the MIME TYPE of the reference value attribute
                attachment. Check all parent tags of reference tag to find the tag with 'mediaType'
                attribute missing. Refer to Shared_Health_Summary_CDA_Implementation_Guide_v1.4
                and 024630 Matching filename extensions of the
                Common_Conformance_Profile_for_Clinical_Documents_v1.6.</assert>           
        ...
        <rule context = "*[@mediaType]/cda:reference">
            ...
            <assert test="@value">Error: Shared Health Summary - Global Clinical Document check
                for '*[@mediaType]/cda:reference' tag - The 'reference' tag 'value' attribute is
                missing. Check all cda:reference tags to find the missing 'value' attribute. Refer
                to Shared_Health_Summary_CDA_Implementation_Guide_v1.4 and 023741 MIME types
                allowed as attachments of the
                Common_Conformance_Profile_for_Clinical_Documents_v1.6.</assert>
            
            <assert test="not(@value) or normalize-space(@value) != ''">Error: Shared Health Summary - 
                ...
                tags to find the empty 'value' attribute. Refer to
                Shared_Health_Summary_CDA_Implementation_Guide_v1.4 and 023741 MIME types
                allowed as attachments of the
                Common_Conformance_Profile_for_Clinical_Documents_v1.6.</assert>
