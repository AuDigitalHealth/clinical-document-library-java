...
_________________________________________________________________________________________________________________________________________________________________________________________
                  ...
                  IG Guide Title     : EXCLUSION STATEMENT - PROBLEMS AND DIAGNOSES
...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Shared_Health_Summary_3A_EXCLUSIONSTATEMENT-PROBLEMSANDDIAGNOSES_7_1_3_2-errors"
        id="p-Shared_Health_Summary_3A_EXCLUSIONSTATEMENT-PROBLEMSANDDIAGNOSES_7_1_3_2-errors"
        see="#p-Shared_Health_Summary_3A_EXCLUSIONSTATEMENT-PROBLEMSANDDIAGNOSES_7_1_3_2-errors">


        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16117']">

            <report test="count(cda:entry[cda:observation/cda:code/@code = '103.16302.120.1.3']) > 1"
                >Error: Shared Health Summary - 7.1.3.2 EXCLUSION STATEMENT - PROBLEMS AND DIAGNOSES -
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16117']/cda:entry[cda:observation/cda:code/@code = '103.16302.120.1.3']">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16117']/cda:entry/cda:observation[cda:code/@code = '103.16302.120.1.3']/cda:id">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16117']/cda:entry/cda:observation[cda:code/@code = '103.16302.120.1.3']/cda:value">
