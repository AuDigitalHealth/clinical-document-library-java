...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- Shared Health Summary Clinical Document: DataType Global Checks -->

    <!-- Context: ClinicalDocument -->

    <!-- Status: Last Reviewed:
         Status: Last Updated : 23/02/2015 -->


    <pattern name="p-Shared_Health_Summary_DataType_Global_Checks-errors"
        id="p-Shared_Health_Summary_DataType_Global_Checks-errors"
        see="#p-Shared_Health_Summary_DataType_Global_Checks-errors">
        ...
        <rule context="cda:value[@xsi:type = 'CS' or substring-after(normalize-space(@xsi:type), ':') = 'CS']">
            ...
            <assert test="@code">Error: Shared Health Summary -
                Global Clinical Document check for value datatype -
            ...
            <assert test="not(@code) or normalize-space(@code) != ''">Error: Shared Health Summary -
                Global Clinical Document check for value datatype -
                The 'value' tag 'code' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=CS' attribute to find the
        ...
        <rule context="cda:value[@xsi:type = 'INT' or substring-after(normalize-space(@xsi:type), ':') = 'INT']">
            ...
            <report test="@value and normalize-space(@value) = ''">Error: Shared Health Summary -
                Global Clinical Document check for value datatype -
                The 'value' tag 'value' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=INT' attribute to find the
                'value' attribute of missing value. Refer to section 'Reference List [NEHT2010c]' of the
        ...
        <rule context="cda:value[@xsi:type = 'PQ' or substring-after(normalize-space(@xsi:type), ':') = 'PQ']">
            ...
            <report test="@unit and normalize-space(@unit) = ''">Error: Shared Health Summary -
                Global Clinical Document check for value datatype -
            ...
            <report test="@unit and not(@value)">Error: Shared Health Summary -
                Global Clinical Document check for value datatype -
            ...
            <report test="@value and not(@unit)">Error: Shared Health Summary -
                Global Clinical Document check for value datatype -
        ...
        <rule context="cda:value[@xsi:type = 'IVL_PQ' or substring-after(normalize-space(@xsi:type), ':') = 'IVL_PQ']">
             ...
             <assert test="cda:low or cda:high or @nullFlavor"
                 >Error: Shared Health Summary - Global Clinical Document check for "cda:value" - The 'value' tag shall
                 ...
                 missing attribute(s) or child tag(s). Refer to section 'Reference List [NEHT2010c]' of the Shared_Health_Summary_CDA_Implementation_Guide_v1.4.</assert>                  
    
            <report test="@nullFlavor and normalize-space(@nullFlavor)=''">Error: Shared Health Summary - Global Clinical
            ...
            <report test="count(cda:low) > 1"
                ...
                Refer to section 'Reference List [NEHT2010c]' of the Shared_Health_Summary_CDA_Implementation_Guide_v1.4.</report>
            ...
            <report test="cda:center"
                 >Error: Shared Health Summary - Global Clinical Document check for "cda:value" - The 'center' tag shall
                 not be present. Check all 'cda:value'
                 tags with 'xsi:type=IVL_PQ' attribute to find the
                 missing attribute(s) or child tag(s). Refer to section 'Reference List [NEHT2010c]' of the Shared_Health_Summary_CDA_Implementation_Guide_v1.4.</report>
            
            <report test="cda:width"
                 >Error: Shared Health Summary - Global Clinical Document check for "cda:value" - The 'width' tag shall
                 not be present. Check all 'cda:value'
                 tags with 'xsi:type=IVL_PQ' attribute to find the
                 missing attribute(s) or child tag(s). Refer to section 'Reference List [NEHT2010c]' of the Shared_Health_Summary_CDA_Implementation_Guide_v1.4.</report>
        ...
        <rule context="cda:value[@xsi:type = 'IVL_PQ' or substring-after(normalize-space(@xsi:type), ':') = 'IVL_PQ']/cda:low | 
           ...
           <assert test="@nullFlavor or @value or @unit">Error: Shared Health Summary - Global Clinical
               ...
               Refer to section 'Reference List [NEHT2010c]' of the Shared_Health_Summary_CDA_Implementation_Guide_v1.4.</assert> 
           ...
           <report test="@nullFlavor and normalize-space(@nullFlavor)=''">Error: Shared Health Summary - Global Clinical
            ...
            <report test="@value and normalize-space(@value)=''">Error: Shared Health Summary - Global Clinical
                Document check for "cda:value" - The 'value' tag's child tag 'value' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=IVL_PQ' attribute. Refer to section 'Reference List [NEHT2010c]' of the
                Shared_Health_Summary_CDA_Implementation_Guide_v1.4.</report>
            
            <report test="@unit and normalize-space(@unit)=''">Error: Shared Health Summary - Global Clinical
                Document check for "cda:value" - The 'value' tag's child tag 'unit' attribute shall contain a value.
                Check all 'cda:value' tags with 'xsi:type=IVL_PQ' attribute. Refer to section 'Reference List [NEHT2010c]' of the
                Shared_Health_Summary_CDA_Implementation_Guide_v1.4.</report>
            
            <report test="@inclusive and normalize-space(@inclusive)=''">Error: Shared Health Summary - Global Clinical
