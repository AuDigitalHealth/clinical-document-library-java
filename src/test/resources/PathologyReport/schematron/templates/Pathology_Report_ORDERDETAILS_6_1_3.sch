...
_________________________________________________________________________________________________________________________________________________________________________________________
                  ...
                  Generated          : 30/04/2015 12:04:10 PM
...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Pathology_Report_ORDERDETAILS_6_1_3-errors"
        id="p-Pathology_Report_ORDERDETAILS_6_1_3-errors"
        see="#p-Pathology_Report_ORDERDETAILS_6_1_3-errors">


        <rule context="/cda:ClinicalDocument">

            <report test="count(cda:inFulfillmentOf) > 1"
                >Error: Pathology Report - 6.1.3 ORDER DETAILS -
                "ORDER DETAILS / Requester Order Identifier (Order Identifier)" -
