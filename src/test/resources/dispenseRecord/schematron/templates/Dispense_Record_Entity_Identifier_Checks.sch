...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Dispense_Record_Entity_Identifier_Checks-errors"
        id="p-Dispense_Record_Entity_Identifier_Checks-errors"
        see="#p-Dispense_Record_Entity_Identifier_Checks-errors">
        ...
        <rule context="ext:asEntityIdentifier/ext:id">
            ...
            <report
                ...
                the Dispense_Record_CDA_Implementation_Guide_v0.4.</report>
            ...
            <report
                ...
                Identifier of the Dispense_Record_CDA_Implementation_Guide_v0.4.</report>
