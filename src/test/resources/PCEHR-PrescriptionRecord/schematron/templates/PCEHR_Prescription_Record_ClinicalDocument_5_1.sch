...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Prescription_Record_ClinicalDocument_5_1-errors"
        id="p-PCEHR_Prescription_Record_ClinicalDocument_5_1-errors"
        see="#p-PCEHR_Prescription_Record_ClinicalDocument_5_1-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:code">
            ...
            <assert test="
                not(@code) or normalize-space(@code) = '' or @code = '100.16764'"
                >Error: PCEHR Prescription Record - 5.1 ClinicalDocument  -
                "ClinicalDocument/code" -
                The 'code' tag 'code' attribute shall contain the value '100.16764'.
                Refer to section 5.1 of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <assert test="
                not(@displayName) or normalize-space(@displayName) = '' or translate(@displayName, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ') = &quot;PCEHR PRESCRIPTION RECORD&quot;"
                >Error: PCEHR Prescription Record - 5.1 ClinicalDocument  -
                "ClinicalDocument/code" -
                The 'code' tag 'displayName' attribute shall contain the value 'PCEHR Prescription Record'.
                Refer to section 5.1 of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>
