...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Prescription_Record_Custodian_5_1_2-errors"
        id="p-PCEHR_Prescription_Record_Custodian_5_1_2-errors"
        see="#p-PCEHR_Prescription_Record_Custodian_5_1_2-errors">


        <rule context="/cda:ClinicalDocument">

            <assert test="cda:custodian"
                >Error: PCEHR Prescription Record - 5.1.2 Custodian -
                "Custodian" -
