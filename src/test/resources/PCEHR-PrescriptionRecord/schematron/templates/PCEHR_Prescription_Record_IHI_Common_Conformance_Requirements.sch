...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Prescription_Record_IHI_Common_Conformance_Requirements-errors"
        id="p-PCEHR_Prescription_Record_IHI_Common_Conformance_Requirements-errors"
        see="#p-PCEHR_Prescription_Record_IHI_Common_Conformance_Requirements-errors">

        <rule context="/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient">

            <report
                test="count(ext:asEntityIdentifier/ext:id[starts-with(@root, '1.2.36.1.2001.1003.0.800360')]) > 1"
                >Error: PCEHR Prescription Record - 6.1.1 Subject of Care - The 'asEntityIdentifier' tag
                ...
                of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
        ...
        <rule
            ...
            <report
                ...
                >Error: PCEHR Prescription Record - 6.1.1 Subject of Care - The 'ext:id' tag
                ...
                Subject of Care of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report
                ...
                >Error: PCEHR Prescription Record - 6.1.1 Subject of Care - The
        ...
        <rule
            ...
            <assert test="@code">Error: PCEHR Prescription Record - 6.1.1 Subject of Care - The 'code'
            ...
            <report test="@code and normalize-space(@code) = ''">Error: PCEHR Prescription Record -
            ...
            <assert test="@codeSystemName">Error: PCEHR Prescription Record - 6.1.1 Subject of Care -
                ...
                Subject of Care of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>

            <report test="@codeSystemName and normalize-space(@codeSystemName) = ''">Error: PCEHR
                Prescription Record - 6.1.1 Subject of Care - The 'code' tag 'codeSystemName' attribute
            ...
            <assert
                ...
                >Error: PCEHR Prescription Record - 6.1.1 Subject of Care - The 'code' tag
