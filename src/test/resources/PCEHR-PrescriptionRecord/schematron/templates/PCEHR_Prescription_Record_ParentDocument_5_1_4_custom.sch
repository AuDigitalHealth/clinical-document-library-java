...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Prescription_Record_ParentDocument_5_1_4_custom-errors"
        id="p-PCEHR_Prescription_Record_ParentDocument_5_1_4_custom-errors"
        see="#p-PCEHR_Prescription_Record_ParentDocument_5_1_4_custom-errors">
        ...
        <!-- 06/11/2012 RS :: JIRA - CDA-2673 :: APND should never be allowed either as a combination or NOT -->
        <!-- 21/09/2012 RS - these tests were added as there is no test template for it in the SGT database -->
        ...
        <rule context="/cda:ClinicalDocument/cda:relatedDocument">
            ...
            <assert test="
                ...
                @typeCode = 'RPLC' or @typeCode = 'XFRM'"
                >Error: PCEHR Prescription Record - 5.1.4 ParentDocument -
                "relatedDocument" -
                The 'relatedDocument' tag 'typeCode' attribute shall be 'RPLC' or 'XFRM'.
                Refer to section 5.1.4 of the
        ...
        <rule context="/cda:ClinicalDocument/cda:relatedDocument[@typeCode = 'XFRM']/cda:parentDocument/cda:id">
            ...
            <!-- 21/11/2012 - This is NOW REMOVED - SEE  JIRA: RPSA-215-->
            
            <!-- If @typeCode="XFRM"; the id/@extension SHALL contain the prescriptionId of the original/parent document. -->
            <!--<assert test="
                not(@extension) or
                normalize-space(@extension) = '' or
                @extension = /cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code='102.16211']/cda:entry/cda:substanceAdministration/cda:id/@extension"
                >Error: PCEHR Prescription Record - 5.1.4 ParentDocument -
                "relatedDocument" -
                The value of 'id' tag 'extension' attribute and the value of the
                original/parent document 'prescriptionId' tag 'extension' attribute shall be matched for 'XFRM' relatedDocument.
                Refer to section 5.1.4 of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0. </assert>-->
