...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Prescription_Record_ParentDocument_5_1_4-errors"
        id="p-PCEHR_Prescription_Record_ParentDocument_5_1_4-errors"
        see="#p-PCEHR_Prescription_Record_ParentDocument_5_1_4-errors">


        <rule context="/cda:ClinicalDocument">

            <assert test="cda:relatedDocument"
                >Error: PCEHR Prescription Record - 5.1.4 ParentDocument -
                "relatedDocument" -
