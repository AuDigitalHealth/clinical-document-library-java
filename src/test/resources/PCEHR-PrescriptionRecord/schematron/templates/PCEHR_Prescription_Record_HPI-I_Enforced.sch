...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- PCEHR_Prescription_Record Clinical Document:  COMMON Conformance Profile - Req no. 3.4.10 Local identifier for a person-->

    <!-- Status: Last Reviewed: 
        Status: Last Updated :  29/08/2013-->


    <pattern name="p-PCEHR_Prescription_Record_HPI-I_Enforced-errors"
        id="p-PCEHR_Prescription_Record_HPI-I_Enforced-errors"
        see="#p-PCEHR_Prescription_Record_HPI-I_Enforced-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:assignedPerson">
            ...
            <assert
                ...
                >Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The 'asEntityIdentifier' tag with
                a HPI-I is missing. Refer to 3.4.10 Local identifier for a person of
                COMMON-ConformProfileClinDoc-v1.4 and section 6.1.2 PrescriptionR section of the
            ...
            <report
                ...
                person of COMMON-ConformProfileClinDoc-v1.4 and section 6.1.2 PrescriptionR section of
                the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
        ...
        <rule
            ...
            <report
                ...
                >Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The 'asEntityIdentifier' tag shall
            ...
            <report test="(ext:code/@code='EI') and not(ext:id/@assigningAuthorityName)">Error:
                PCEHR Prescription Record - 6.1.2 PrescriptionR - The 'asEntityIdentifier' tag having a
                ...
                section 6.1.2 PrescriptionR section of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>

            <report
                test="(ext:code/@code='EI') and (ext:id/@assigningAuthorityName) and normalize-space(ext:id/@assigningAuthorityName) = ''"
                >Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The 'ext:id' tag
            ...
            <report
                ...
                >Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The
        ...
        <rule
            ...
            <report test="@nullFlavor">Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The 'id' tag
                'nullFlavor' attribute shall not exist. Refer to section 3.4.10 Local identifier for
                a person of COMMON-ConformProfileClinDoc-v1.4 and section 6.1.2 PrescriptionR of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>

            <report
                test="(starts-with(@root, '1.2.36.1.2001.1005.41')) and not(starts-with(@root, '1.2.36.1.2001.1005.41.800362'))"
                >Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The 'id' tag 'root' attribute
                ...
                3.4.10 Local identifier for a person of COMMON-ConformProfileClinDoc-v1.4 and
                section 6.1.2 PrescriptionR of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report
                ...
                and section 6.1.2 PrescriptionR of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report
                ...
                identifier for a person of COMMON-ConformProfileClinDoc-v1.4 and section 6.1.2
                PrescriptionR of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report
                ...
                COMMON-ConformProfileClinDoc-v1.4 and section 6.1.2 PrescriptionR of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</report>
        ...
        <rule
            ...
            <assert test="@codeSystem">Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The 'code'
                tag 'codeSystem' attribute is missing. Refer to 3.4.10 Local identifier for a person
                of COMMON-ConformProfileClinDoc-v1.4 and section 6.1.2 PrescriptionR section of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>

            <report test="@codeSystem and normalize-space(@codeSystem) = ''">Error: PCEHR Prescription
                Record - 6.1.2 PrescriptionR - The 'code' tag 'codeSystem' attribute shall contain a
            ...
            <assert
                ...
                >Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The 'code' tag 'codeSystem'
                attribute shall contain the '2.16.840.1.113883.12.203' value. Refer to 3.4.10 Local
                identifier for a person of COMMON-ConformProfileClinDoc-v1.4 and section 6.1.2
                PrescriptionR section of the
                PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>

            <assert test="@codeSystemName">Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The
                'code' tag 'codeSystemName' attribute is missing. Refer to 3.4.10 Local identifier
                for a person of COMMON-ConformProfileClinDoc-v1.4 and section 6.1.2 PrescriptionR
                section of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>

            <report test="@codeSystemName and normalize-space(@codeSystemName) = ''">Error: PCEHR
                Prescription Record - 6.1.2 PrescriptionR - The 'code' tag 'codeSystemName' attribute shall
            ...
            <assert
                ...
                >Error: PCEHR Prescription Record - 6.1.2 PrescriptionR - The 'code' tag 'codeSystemName'
