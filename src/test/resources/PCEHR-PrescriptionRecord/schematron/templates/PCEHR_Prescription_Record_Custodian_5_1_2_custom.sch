...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-PCEHR_Prescription_Record_Custodian_5_1_2_custom-errors"
        id="p-PCEHR_Prescription_Record_Custodian_5_1_2_custom-errors"
        see="#p-PCEHR_Prescription_Record_Custodian_5_1_2_custom-errors">
        ...
        <rule
            ...
            <assert test="ext:asEntityIdentifier">Error: PCEHR Prescription Record - 5.1.2 Custodian -
            ...
            <assert test="cda:name">Error: PCEHR Prescription Record - 5.1.2 Custodian - "custodian /
                ...
                section 5.1.2 of the PCEHR_Prescription_Record_CDA_Implementation_Guide_v1.0.</assert>
        ...
        <rule
            ...
            <report
                ...
                >Error: PCEHR Prescription Record - 5.1.2 Custodian - "custodian / assignedCustodian /
