...
_________________________________________________________________________________________________________________________________________________________________________________________
                  ...
                  Generated          : 1/06/2015 3:17:47 PM
...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Referral_SUBJECTOFCARE_6_1_2-errors"
        id="p-e-Referral_SUBJECTOFCARE_6_1_2-errors"
        see="#p-e-Referral_SUBJECTOFCARE_6_1_2-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:administrativeGenderCode/cda:translation">

            <assert test="not(@nullFlavor)"
                >Error: e-Referral - 6.1.2 SUBJECT OF CARE -
                "Subject of Care / Participant / Person or Organisation or Device / Person / Demographic Data / Sex" -
                The 'translation' tag 'nullFlavor' attribute shall not be present.
                Refer to 6.1.2 of the
                e-Referral_CDA_Implementation_Guide_v2.2.</assert>
