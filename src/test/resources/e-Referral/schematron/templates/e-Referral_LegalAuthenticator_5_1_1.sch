...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Referral_LegalAuthenticator_5_1_1-errors"
        id="p-e-Referral_LegalAuthenticator_5_1_1-errors"
        see="#p-e-Referral_LegalAuthenticator_5_1_1-errors">


        <rule context="/cda:ClinicalDocument">

            <report test="count(cda:legalAuthenticator) > 1"
                >Error: e-Referral - 5.1.1 LegalAuthenticator -
                "LegalAuthenticator" -
