...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Referral_IHI_Common_Conformance_Requirements_Part1-errors"
        id="p-e-Referral_IHI_Common_Conformance_Requirements_Part1-errors"
        see="#p-e-Referral_IHI_Common_Conformance_Requirements_Part1-errors">
...
<!-- Refer to 3.4.10 of the Common Conformance Profile -->
        ...
        <rule context="/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/ext:asEntityIdentifier"> 
            ...
            <assert test="not(ext:id) or (ext:id/@root)">Error: e-Referral - 6.1.2 SUBJECT OF CARE -
            ...
            <report
                ...
                >Error: e-Referral - 6.1.2 SUBJECT OF CARE - The 'asEntityIdentifier' tag shall
                have a National Identifier or a Local Identifier but not both. Refer to "023876 - Local identifier
                details for a person in an Entity Identifier element" of the
                Clinical_Documents_Common_Conformance_Profile_v1.6 and
                "section 6.1.2 SUBJECT OF CARE" of the e-Referral_CDA_Implementation_Guide_v2.2.</report>
            ...
            <report
                ...
                >Error: e-Referral - 6.1.2 SUBJECT OF CARE - The 'asEntityIdentifier' tag shall not
            ...
            <report
                ...
                >Error: e-Referral - 6.1.2 SUBJECT OF CARE - The 'asEntityIdentifier' tag for
            ...
            <report
                ...
                >Error: e-Referral - 6.1.2 SUBJECT OF CARE - The 'ext:id/@assigningAuthorityName'
        ...
        <rule context="/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/ext:asEntityIdentifier/ext:id[starts-with(@root, '1.2.36.1.2001.1005.29.') or (@root = '1.2.36.1.2001.1005.29')]">
            ...
            <assert test="not(@root) or (starts-with(@root, '1.2.36.1.2001.1005.29.800362'))">Error: 
                e-Referral - 6.1.2 SUBJECT OF CARE - The 'ext:id' tag 'root' attribute SHALL be 
            ...
            <report
                ...
                >Error: e-Referral - 6.1.2 SUBJECT OF CARE - The 'ext:id' tag 'root' attribute SHALL be 
                the OID 1.2.36.1.2001.1005.29 followed by the national healthcare identifier 
                of the organisation that maintains the local identifier. 
                Refer to "023876 - Local identifier
                details for a person in an Entity Identifier element" of the
        ...
        number(substring(substring-after(@root, '80036'), 11, 1))
                ...
                >Error: e-Referral - 6.1.2 SUBJECT OF CARE - The 'ext:id' tag 'root' attribute having 
                the OID 1.2.36.1.2001.1005.29 followed by the national healthcare identifier 
        ...
        <rule context="/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/ext:asEntityIdentifier[not(ext:id[starts-with(@root, '1.2.36.1.2001.1003.0.') or (@root = '1.2.36.1.2001.1003.0')])]/ext:code">
            ...
            <assert test="@code">Error: e-Referral - 6.1.2 SUBJECT OF CARE - The 'ext:code' tag 'code' 
                attribute is missing. Refer to "023876 - Local identifier
                details for a person in an Entity Identifier element" of the
                Clinical_Documents_Common_Conformance_Profile_v1.6 and
                "section 6.1.2 SUBJECT OF CARE" of the e-Referral_CDA_Implementation_Guide_v2.2.</assert>
            ...
            <assert test="@codeSystem">Error: e-Referral - 6.1.2 SUBJECT OF CARE - The 'ext:code' tag 'codeSystem' 
                attribute is missing. Refer to "023876 - Local identifier
                details for a person in an Entity Identifier element" of the
                Clinical_Documents_Common_Conformance_Profile_v1.6 and
                "section 6.1.2 SUBJECT OF CARE" of the e-Referral_CDA_Implementation_Guide_v2.2.</assert>
            ...
            <assert test="@codeSystemName">Error: e-Referral - 6.1.2 SUBJECT OF CARE - The 'ext:code' tag 'codeSystemName' 
                attribute is missing. Refer to "023876 - Local identifier
                details for a person in an Entity Identifier element" of the
                Clinical_Documents_Common_Conformance_Profile_v1.6 and
                "section 6.1.2 SUBJECT OF CARE" of the e-Referral_CDA_Implementation_Guide_v2.2.</assert>
