...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Referral_DVA_File_Number_Checks-errors"
        id="p-e-Referral_DVA_File_Number_Checks-errors"
        see="#p-e-Referral_DVA_File_Number_Checks-errors">
        ...
        <rule context="ext:entitlement[(ext:code/@codeSystem = '1.2.36.1.2001.1001.101.104.16047') and ((ext:code/@code = '5') or (ext:code/@code = '6') or (ext:code/@code = '7'))]/ext:id">
            ...
            <assert test="@root">Error: e-Referral -
