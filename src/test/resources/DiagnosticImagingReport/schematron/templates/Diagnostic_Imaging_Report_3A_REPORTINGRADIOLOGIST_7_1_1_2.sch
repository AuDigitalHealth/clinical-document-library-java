...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Diagnostic_Imaging_Report_3A_REPORTINGRADIOLOGIST_7_1_1_2-errors"
        id="p-Diagnostic_Imaging_Report_3A_REPORTINGRADIOLOGIST_7_1_1_2-errors"
        see="#p-Diagnostic_Imaging_Report_3A_REPORTINGRADIOLOGIST_7_1_1_2-errors">


        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16945']/ext:coverage2[ext:entitlement/ext:participant/@typeCode = 'HLD']">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16945']/ext:coverage2/ext:entitlement[ext:participant/@typeCode = 'HLD']">
            ...
            <assert test="ext:id"
                >Error: Diagnostic Imaging Report - 7.1.1.2 REPORTING RADIOLOGIST -
                "REPORTING RADIOLOGIST Participant / Entitlement / Entitlement Number" -
            ...
            <assert test="ext:code"
                >Error: Diagnostic Imaging Report - 7.1.1.2 REPORTING RADIOLOGIST -
                "REPORTING RADIOLOGIST Participant / Entitlement / Entitlement Type" -
            ...
            <report test="count(ext:effectiveTime) > 1"
                >Error: Diagnostic Imaging Report - 7.1.1.2 REPORTING RADIOLOGIST -
                "REPORTING RADIOLOGIST Participant / Entitlement / Entitlement Validity Duration" -
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16945']/ext:coverage2/ext:entitlement/ext:participant[@typeCode = 'HLD']/ext:participantRole">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16945']/ext:coverage2/ext:entitlement/ext:participant[@typeCode = 'HLD']/ext:participantRole/ext:id">
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '101.16945']/ext:coverage2/ext:entitlement[ext:participant/@typeCode = 'HLD']/ext:code">
