...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- Diagnostic Imaging Report Clinical Document:  Global Checks -->

    <!-- Context: ClinicalDocument -->

    <!-- Status: Last Reviewed:
         Status: Last Updated : 21/04/2015 -->


    <pattern name="p-Diagnostic_Imaging_Report_Global_Checks-errors"
        id="p-Diagnostic_Imaging_Report_Global_Checks-errors"
        see="#p-Diagnostic_Imaging_Report_Global_Checks-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:component">    
             <report test="cda:nonXMLBody"
                 ...
                 Clinical_Documents_Common_Conformance_Profile_v1.6</report>
        </rule>
...
-->
            ...
            <!-- @extension shall be started with 6 numeric numbers -->
            <assert test="
                not(@root) or
                not(@root = '1.2.36.174030967.0.3') or
                not(@extension) or
                ...
                >Error: Diagnostic Imaging Report -
                Global Clinical Document check for 'id' tag -
                The 'id' tag 'extension' attribute shall be a Medicare Prescriber Number that starts with 6 numeric numbers.
                Check all 'cda:id' or 'ext:id' tags to find the incorrect value.
                Refer to FAQ Vendor advice regarding OIDs in HL7 CDA documents, and section 8.2 of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report
                ...
                ">Error: Diagnostic Imaging Report - Global Clinical Document check for
            ...
            <report
                ...
                Refer to section 8.2 id of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
...
-->
        ...
        <rule context="ext:asEntityIdentifier">
            ...
            <assert test="@classCode">Error: Diagnostic Imaging Report -
            ...
            <assert test="not(@classCode) or normalize-space(@classCode) != ''">Error: Diagnostic Imaging Report -
                Global Clinical Document check for "ext:asEntityIdentifier" tag -
            ...
            <assert test="ext:id">Error: Diagnostic Imaging Report -
            ...
            <!--
            <assert test="ext:id/@assigningAuthorityName">Error: Diagnostic Imaging Report -
            ...
            <!-- Other attributes of "ext:id" are being tested by Diagnostic_Imaging_Report_Global_Checks.sch. -->
            ...
            <!-- The attributes of "ext:code" (code, codeSystem, codeSystemName, displayName) are being tested by Diagnostic_Imaging_Report_Global_Checks.sch. -->
        ...
        <rule context="cda:name[not(
            ...
            <report test="cda:family and not(cda:family[@nullFlavor]) and normalize-space(cda:family) = ''"
                >Error: Diagnostic Imaging Report - Global Clinical Document check for "name" tag - The 'family' tag
...
<!-- ext:telecom is added due to new schema released for pathology Release 5 My Health Record-->
        ...
        <rule context="cda:addr[not(ancestor::cda:birthplace)] | ext:addr">
            ...
            <report test="count(cda:streetNameType) > 1"
                ...
                Refer to section 8.6 of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report test="
                ...
                Healthcare Client Identification: Australian Postal Delivery Type Code.
                Check all 'cda:addr' and/or 'ext:addr' tags to find the non-conforming 'deliveryAddressLine' tag.
                Refer to section 8.6 of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
    ...
    <!-- ext:telecom is added due to new schema released for pathology Release 5 My Health Record-->
        ...
        <rule context = "cda:component/cda:section[not(descendant::cda:component/cda:section) and
            ...
            <assert test = "cda:title"
                ...
                Refer to "025054 - Requirements for title element" of the Clinical_Documents_Common_Conformance_Profile_v1.6 
                and Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report test = "count(cda:title) > 1"
                ...
                Refer to "025054 - Requirements for title element" of the Clinical_Documents_Common_Conformance_Profile_v1.6 
                and Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            ...
            <assert test = "cda:text"
                ...
                Refer to "025053 - Sections with no requirement for narrative" of the Clinical_Documents_Common_Conformance_Profile_v1.6 
                and Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
        ...
        <rule context = "cda:component/cda:section[not(descendant::cda:component/cda:section) and
            ...
            <assert test = "not(starts-with(ancestor::cda:section//cda:observationMedia[@ID = current()/@referencedObject]/cda:value/cda:reference/@value, '#'))"
                ...
                Refer to "023741 - MIME types allowed as attachments" of the Clinical_Documents_Common_Conformance_Profile_v1.6 
                and Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
        ...
        <rule context = "cda:observationMedia[translate(@ID, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')!='LOGO']">
            ...
            <assert test = "ancestor::cda:component[cda:section]"
                ...
                Refer to "024482 - Conformance levels" of the Clinical_Documents_Common_Conformance_Profile_v1.6 
                and Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <assert test = "@ID">Error: Diagnostic Imaging Report -
                Global Clinical Document check for 'observationMedia' tag -
            ...
            <assert test = "not(@ID) or normalize-space(@ID) != ''">Error: Diagnostic Imaging Report -
            ...
            <assert test = "cda:value">Error: Diagnostic Imaging Report -
            ...
            <report test = "count(cda:value) > 1">Error: Diagnostic Imaging Report -
        ...
        <rule context = "cda:observationMedia[translate(@ID, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')='LOGO']">
            ...
            <report test = "(cda:value) and (cda:value/@representation) and normalize-space(cda:value/@representation)='B64'"
                ...
                Refer to Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0 and section 4.2.1 of the
        ...
        <rule context = "cda:observationMedia/cda:value">
            ...
            <assert test = "not(@mediaType) or
                ...
                NOTE: This restriction shall be applied to 'My Health Record' messages only. Ignore this error for 'non-My Health Record' messages.
            ...
            <assert test = "not(@mediaType) or (cda:reference)">Error: Diagnostic Imaging Report -
            ...
            <report test = "(@mediaType) and (count(cda:reference) > 1)">Error: Diagnostic Imaging Report -
                Global Clinical Document check for 'observationMedia/value' tag - The 'reference'
            ...
            <assert test="not(cda:reference/@value) or (normalize-space(cda:reference/@value) = '') or not(@mediaType) or (normalize-space(@mediaType) = '') or
                ...
                ">Error: Diagnostic Imaging Report - Global Clinical Document check for 'observationMedia/value' tag - 
                ...
                with each other. Refer to "023741 - MIME types allowed as attachments" of the Clinical_Documents_Common_Conformance_Profile_v1.6 
                and Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>            
