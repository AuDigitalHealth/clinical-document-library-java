...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Diagnostic_Imaging_Report_LegalAuthenticator_5_1_1-errors"
        id="p-Diagnostic_Imaging_Report_LegalAuthenticator_5_1_1-errors"
        see="#p-Diagnostic_Imaging_Report_LegalAuthenticator_5_1_1-errors">


        <rule context="/cda:ClinicalDocument">

            <report test="count(cda:legalAuthenticator) > 1"
                >Error: Diagnostic Imaging Report - 5.1.1 LegalAuthenticator -
                "LegalAuthenticator" -
