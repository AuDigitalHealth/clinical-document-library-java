...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Diagnostic_Imaging_Report_DocumentAuthor_6_1_2_custom-errors"
        id="p-Diagnostic_Imaging_Report_DocumentAuthor_6_1_2_custom-errors"
        see="#p-Diagnostic_Imaging_Report_DocumentAuthor_6_1_2_custom-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:addr">
            ...
            <assert
                ...
                >Error: Diagnostic Imaging Report - 6.1.2 Document Author - "Document Author /
