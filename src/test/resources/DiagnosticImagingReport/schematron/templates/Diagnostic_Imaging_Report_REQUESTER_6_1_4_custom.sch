...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Diagnostic_Imaging_Report_REQUESTER_6_1_4_custom-errors"
        id="p-Diagnostic_Imaging_Report_REQUESTER_6_1_4_custom-errors"
        see="#p-Diagnostic_Imaging_Report_REQUESTER_6_1_4_custom-errors">
        ...
        <rule context="/cda:ClinicalDocument/cda:participant/cda:associatedEntity/cda:addr">
            ...
            <assert
                ...
                >Error: Diagnostic Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant /
                Address" - The 'country' tag shall contain the value 'Australia'. Refer to section
                6.1.4 of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report
                ...
                HealthCare Client Identifier Address Purpose. Refer to section 6.1.4 of the
        ...
        <rule context="/cda:ClinicalDocument/cda:participant/cda:associatedEntity/cda:telecom">
            ...
            <assert test="not(@use) or normalize-space(@use) = '' or  @use='WP' ">Error: Diagnostic
                Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant / Electronic
                Communication Detail" - The 'telecom' tag 'use' attribute shall be set to Workplace
                see HL7 v3: TelecommunicationAddressUse. Refer to section 6.1.4 of the
        ...
        <rule
            ...
            <assert test="@classCode">Error: Diagnostic Imaging Report - 6.1.4 REQUESTER -
                "REQUESTER / Participant / Person or Organisation or Device / Person / Employment
                Detail" - The 'asEmployment' tag 'classCode' attribute is missing. Refer to section
                6.1.4 REQUESTER of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>

            <assert test="not(@classCode) or normalize-space(@classCode) != ''">Error: Diagnostic
                Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant / Person or Organisation
                or Device / Person / Employment Detail" - The 'asEmployment' tag 'classCode'
            ...
            <assert
                ...
                >Error: Diagnostic Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant /
                Person or Organisation or Device / Person / Employment Detail" - The 'asEmployment'
                tag 'classCode' attribute shall contain the value 'EMP'. Refer to section 6.1.4
                REQUESTER of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report test="count(ext:employerOrganization) > 1">Error: Diagnostic Imaging Report -
                ...
                Person / Employment Detail" - The 'ext:employerOrganization' tag shall appear only
                once. Refer to section 6.1.4 REQUESTER of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>

            <!-- ext:code -->
            <report test="count(ext:code) > 1">Error: Diagnostic Imaging Report - 6.1.4 REQUESTER -
                "REQUESTER / Participant / Person or Organisation or Device / Person / Employment
                Detail" - The 'ext:code' tag shall appear only once. Refer to section 6.1.4
                REQUESTER of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>

            <!-- ext:jobCode -->
            <report test="count(ext:jobCode) > 1">Error: Diagnostic Imaging Report - 6.1.4 REQUESTER
                - "REQUESTER / Participant / Person or Organisation or Device / Person / Employment
                Detail" - The 'ext:jobCode' tag shall appear only once. Refer to section 6.1.4
                REQUESTER of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>

            <!-- ext:jobClassCode -->
            <report test="count(ext:jobClassCode) > 1">Error: Diagnostic Imaging Report - 6.1.4
                REQUESTER - "REQUESTER / Participant / Person or Organisation or Device / Person /
                Employment Detail" - The 'ext:jobClassCode' tag shall appear only once. Refer to
        ...
        <rule
            ...
            <assert test="cda:asOrganizationPartOf">Error: Diagnostic Imaging Report - 6.1.4
                REQUESTER - "REQUESTER / Participant / Person or Organisation or Device / Person /
                Employment Detail / Employer Organisation" - The 'asOrganizationPartOf' tag is
            ...
            <report test="count(cda:asOrganizationPartOf) > 1">Error: Diagnostic Imaging Report -
                6.1.4 REQUESTER - "REQUESTER / Participant / Person or Organisation or Device /
                Person / Employment Detail / Employer Organisation" - The 'asOrganizationPartOf' tag
                shall appear only once. Refer to section 6.1.4 REQUESTER of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>

            <!-- name -->
            <report test="count(cda:name) > 1">Error: Diagnostic Imaging Report - 6.1.4 REQUESTER -
                "REQUESTER / Participant / Person or Organisation or Device / Person / Employment
        ...
        <rule
            ...
            <!-- wholeOrganization -->
            <assert test="cda:wholeOrganization">Error: Diagnostic Imaging Report - 6.1.4 REQUESTER
                - "REQUESTER / Participant / Person or Organisation or Device / Person / Employment
                Detail / Employer Organisation / Organisation" - The 'wholeOrganization' tag is
                missing. Refer to section 6.1.4 REQUESTER of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>

            <report test="count(cda:wholeOrganization) > 1">Error: Diagnostic Imaging Report - 6.1.4
                REQUESTER - "REQUESTER / Participant / Person or Organisation or Device / Person /
        ...
        <rule
           ...
           <!-- The tags and attributes of 'ext:asEntityIdentifier' are being tested in 'Diagnostic_Imaging_Report_Global_Checks.sch'. -->
            ...
            <!-- name -->
            <assert test="cda:name">Error: Diagnostic Imaging Report - 6.1.4 REQUESTER - "REQUESTER
        ...
        <rule
            ...
            <report
                ...
                Organisation / Entity Identifier" - The 'id' tag 'root' attribute shall contain an
                OID for HPI-O Organisation Health Identifier, which should be ended with a national
                16 digits unique identification number. Refer to section 6.1.4 REQUESTER and section
                8.2 of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report
                ...
                Person or Organisation or Device / Person / Employment Detail / Employer
                Organisation / Entity Identifier" - The 'id' tag 'root' attribute shall contain an
                OID for PAI-O Health Identifier, which should be ended with a national 16 digits
        ...
        <rule
            ...
            <report test="@use and normalize-space(@use) = ''">Error: Diagnostic Imaging Report -
                6.1.4 REQUESTER - "REQUESTER / Participant / Person or Organisation or Device /
                Person / Employment Detail / Employer Organisation / Organisation / Organisation
                Name" - The 'name' tag 'use' attribute shall contain a value. Refer to section 10.4
            ...
            <report
                ...
                >Error: Diagnostic Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant /
                Person or Organisation or Device / Person / Employment Detail / Employer
                Organisation / Organisation / Organisation Name" - The 'name' tag 'use' attribute
                shall be coded as per AS 4846-2006: Health Care Provider Organisation Name
                Usage.Refer to section 10.4 AS 4846-2006: Health Care Provider Organisation Name
                Usage of the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
        ...
        <rule
            ...
            <!-- name/@ -->
            <assert test="normalize-space(.) != ''">Error: Diagnostic Imaging Report - 6.1.4
                REQUESTER - "REQUESTER / Participant / Person or Organisation or Device / Person /
                Employment Detail / Employer Organisation / Organisation / Department/Unit" - The
                'name' tag shall contain a value. Refer to section 6.1.4 REQUESTER of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
        ...
        <rule
            ...
            <!-- jobCode/@code - 1..1 -->
            <assert test="@code">Error: Diagnostic Imaging Report - 6.1.4 REQUESTER - "REQUESTER /
                Participant / Person or Organisation or Device / Person / Employment Detail /
            ...
            <assert test="not(@code) or normalize-space(@code) != ''">Error: Diagnostic Imaging
                ...
                Device / Person / Employment Detail / Occupation" - The 'jobCode' tag 'code'
                attribute shall contain a value. Refer to section 6.1.4 REQUESTER of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <assert test="@codeSystem">Error: Diagnostic Imaging Report - 6.1.4 REQUESTER -
                "REQUESTER / Participant / Person or Organisation or Device / Person / Employment
                Detail / Occupation" - The 'jobCode' tag 'codeSystem' attribute is missing. Refer to
                section 6.1.4 REQUESTER of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>

            <assert test="not(@codeSystem) or normalize-space(@codeSystem) != ''">Error: Diagnostic
                Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant / Person or Organisation
                or Device / Person / Employment Detail / Occupation" - The 'jobCode' tag
                'codeSystem' attribute shall contain a value. Refer to section 6.1.4 REQUESTER of
            ...
            <assert
                ...
                >Error: Diagnostic Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant /
                Person or Organisation or Device / Person / Employment Detail / Occupation" - The
                'jobCode' tag 'codeSystem' attribute shall be as per '1220.0 - ANZSCO - Australian
           ...
           <report test="@codeSystemName and normalize-space(@codeSystemName) = ''">Error:
                Diagnostic Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant / Person or
           ...
           <!-- jobCode/@codeSystemVersion -->
            ...
            <report test="@displayName and normalize-space(@displayName) = ''">Error: Diagnostic
                Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant / Person or Organisation
                or Device / Person / Employment Detail / Occupation" - The 'jobCode' tag
                'displayName' attribute shall contain a value. Refer to section 6.1.4 REQUESTER of
                the Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
            ...
            <report
                ...
                >Error: Diagnostic Imaging Report - 6.1.4 REQUESTER - "REQUESTER / Participant /
                Person or Organisation or Device / Person / Employment Detail / Occupation" - The
                'jobCode' tag 'code' and 'displayName' attributes shall match as per '1220.0 -
                ANZSCO - Australian and New Zealand Standard Classification of Occupations, First
                Edition, Revision 1'. Refer to section 6.1.4 REQUESTER of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</report>
