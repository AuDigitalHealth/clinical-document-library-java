...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Prescription_Request_AMT_and_SNOMED_CT_AU_Concepts_Identifier_Checks-errors"
        id="p-Prescription_Request_AMT_and_SNOMED_CT_AU_Concepts_Identifier_Checks-errors"
        see="#p-Prescription_Request_AMT_and_SNOMED_CT_AU_Concepts_Identifier_Checks-errors">
        ...
        <rule
            ...
            <report test="starts-with(@code, '0')">Error: Prescription Request - Global Clinical
                ...
                the Prescription_Request_CDA_Implementation_Guide_v0.5 and
                AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</report>

            <assert test="string-length(@code) &gt;= 6">Error: Prescription Request - Global
            ...
            <assert test="number(@code) &gt;= 100001">Error: Prescription Request - Global Clinical
                Document check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
            ...
            <assert test="string-length(@code) &lt;= 18">Error: Prescription Request - Global
                Clinical Document check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
            ...
            <assert test="number(@code) &lt;= 999999999999999999">Error: Prescription Request -
                Global Clinical Document check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
            ...
            <assert test="normalize-space(@code) = @code">Error: Prescription Request - Global
                Clinical Document check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
                ...
                to section 8.1 of the Prescription_Request_CDA_Implementation_Guide_v0.5 and
                AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>
            ...
            <assert test="number(@code) = floor(@code)">Error: Prescription Request - Global
                Clinical Document check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
            ...
            <assert test="number(@code)">Error: Prescription Request - Global Clinical Document
