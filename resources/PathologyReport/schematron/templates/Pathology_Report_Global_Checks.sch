...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- Pathology Report Clinical Document:  Global Checks -->
    ...
    <pattern name="p-Pathology_Report_Global_Checks-errors"
        id="p-Pathology_Report_Global_Checks-errors"
        see="#p-Pathology_Report_Global_Checks-errors">
...
-->
            ...
            <report
                ...
                Refer to section 8.2 id of the Pathology_Report_CDA_Implementation_Guide_v1.0.</report>
...
-->
        ...
        <rule context="ext:asEntityIdentifier">
            ...
            <assert test="@classCode">Error: Pathology Report -
            ...
            <assert test="not(@classCode) or normalize-space(@classCode) != ''">Error: Pathology Report -
                Global Clinical Document check for "ext:asEntityIdentifier" tag -
            ...
            <assert test="ext:id">Error: Pathology Report -
            ...
            <!--
            <assert test="ext:id/@assigningAuthorityName">Error: Pathology Report -
            ...
            <!-- Other attributes of "ext:id" are being tested by Pathology_Report_Global_Checks.sch. -->
            ...
            <!-- The attributes of "ext:code" (code, codeSystem, codeSystemName, displayName) are being tested by Pathology_Report_Global_Checks.sch. -->
        ...
        <rule context="cda:name[not(
            ...
            <report test="cda:family and not(cda:family[@nullFlavor]) and normalize-space(cda:family) = ''"
                >Error: Pathology Report - Global Clinical Document check for "name" tag - The 'family' tag
...
<!-- ext:telecom is added due to new schema released for pathology Release 5 My Health Record-->
        ...
        <rule context="cda:addr[not(ancestor::cda:birthplace)] | ext:addr">
            ...
            <report test="count(cda:streetNameType) > 1"
                ...
                Refer to section 8.6 of the Pathology_Report_CDA_Implementation_Guide_v1.0.</report>
    ...
    <!-- ext:telecom is added due to new schema released for pathology Release 5 My Health Record-->
        ...
        <rule context = "cda:component/cda:section[not(descendant::cda:component/cda:section) and
            ...
            <assert test = "cda:title"
                ...
                and Pathology_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <report test = "count(cda:title) > 1"
                ...
                Refer to "025054 - Requirements for title element" of the Clinical_Documents_Common_Conformance_Profile_v1.6 
                and Pathology_Report_CDA_Implementation_Guide_v1.0.</report>
        ...
        <rule context = "cda:observationMedia[translate(@ID, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')!='LOGO']">
            ...
            <assert test = "@ID">Error: Pathology Report -
                Global Clinical Document check for 'observationMedia' tag -
            ...
            <assert test = "not(@ID) or normalize-space(@ID) != ''">Error: Pathology Report -
            ...
            <assert test = "cda:value">Error: Pathology Report -
            ...
            <report test = "count(cda:value) > 1">Error: Pathology Report -
        ...
        <rule context = "cda:observationMedia[translate(@ID, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')='LOGO']">
            ...
            <report test = "(cda:value) and (cda:value/@representation) and normalize-space(cda:value/@representation)='B64'"
                ...
                Refer to Pathology_Report_CDA_Implementation_Guide_v1.0 and section 4.2.1 of the
        ...
        <rule context = "cda:observationMedia/cda:value">
            ...
            <assert test = "not(@mediaType) or
                ...
                >Error: Pathology Report -
                Global Clinical Document check for 'observationMedia/value' tag - The 'value' tag
            ...
            <assert test = "not(@mediaType) or
                ...
                'mediaType' attribute shall be as per CDA Limitation MIME Type defined inside
                "Common_Conformance_Profile_for_Clinical_Documents_v1.6".
                NOTE: This restriction shall be applied to 'My Health Record' message only. Ignore this error for 'non-My Health Record' messages.
                Check all 'cda:observationMedia/cda:value' tags to find the incorrect 'mediaType' attribute.
                Refer to "023741 - MIME types allowed as attachments" of the Clinical_Documents_Common_Conformance_Profile_v1.6 
                and Pathology_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <assert test = "not(@mediaType) or (cda:reference)">Error: Pathology Report -
            ...
            <report test = "(@mediaType) and (count(cda:reference) > 1)">Error: Pathology Report -
                Global Clinical Document check for 'observationMedia/value' tag - The 'reference'
            ...
            <assert test="not(cda:reference/@value) or (normalize-space(cda:reference/@value) = '') or not(@mediaType) or (normalize-space(@mediaType) = '') or
                ...
                ">Error: Pathology Report - Global Clinical Document check for 'observationMedia/value' tag - 
