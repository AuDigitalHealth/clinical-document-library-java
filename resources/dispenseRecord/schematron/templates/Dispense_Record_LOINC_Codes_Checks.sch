...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Dispense_Record_LOINC_Codes_Checks-errors"
        id="p-Dispense_Record_LOINC_Codes_Checks-errors"
        see="#p-Dispense_Record_LOINC_Codes_Checks-errors">
...
-->
        ...
        <rule context="*[(@codeSystem='2.16.840.1.113883.6.1')]">
            ...
            <report test="(@codeSystemName) and (@codeSystemName != 'LOINC')">Error: Dispense Record
            ...
            <assert test="string-length(@code) &gt;= 3">Error: Dispense Record - Global Clinical
            ...
            <assert test="string-length(@code) &lt;= 10">Error: Dispense Record - Global Clinical
                Document check for LOINC "*[(@codeSystem='2.16.840.1.113883.6.1')]/@code" attribute
            ...
            <assert test="(substring(@code, (string-length(@code)-1), 1) = '-')">Error: Dispense
                Record - Global Clinical Document check for LOINC
            ...
            <assert
                ...
                >Error: Dispense Record - Global Clinical Document check for LOINC
                "*[(@codeSystem='2.16.840.1.113883.6.1')]/@code" attribute - The 'code' attribute
            ...
            <assert test="not(contains(@code, '.'))">Error: Dispense Record - Global Clinical
                Document check for LOINC "*[(@codeSystem='2.16.840.1.113883.6.1')]/@code" attribute
