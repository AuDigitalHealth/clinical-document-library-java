...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <!-- Dispense Record Clinical Document:  Global Checks -->
    ...
    <pattern name="p-Dispense_Record_Global_Checks-errors"
        id="p-Dispense_Record_Global_Checks-errors"
        see="#p-Dispense_Record_Global_Checks-errors">
       ...
       <!-- 
        ...
        <rule
            ...
            <report test="starts-with(@code, '0')">Error: Dispense Record - Global Clinical Document check
                ...
                of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013 and AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</report>
            ...
            <assert test="string-length(@code) &gt;= 6">Error: Dispense Record - Global Clinical
                ...
                such 'code' attributes to find the incorrect attribute(s). Refer to section A1
                of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013 and AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>

            <assert test="number(@code) &gt;= 100001">Error: Dispense Record - Global Clinical Document
                ...
                attribute(s). Refer to section A1 of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013 and
            ...
            <assert test="string-length(@code) &lt;= 18">Error: Dispense Record - Global Clinical
                ...
                section A1 of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013 and
                AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>
            ...
            <assert test="normalize-space(@code) = @code">Error: Dispense Record - Global Clinical Document
                check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
                ...
                to section A1 of the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013 and
                AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>

            <assert test="string-length(normalize-space(@code)) = string-length(@code)">Error:
                Dispense Record - Global Clinical Document check for
            ...
            <assert test="number(@code) = floor(@code)">Error: Dispense Record - Global Clinical Document
                check for "*[(@codeSystem='2.16.840.1.113883.6.96') or
                (@codeSystem='1.2.36.1.2001.1004.100')]/@code" attribute - The ‘code’ attribute
            ...
            <assert test="number(@code)">Error: Dispense Record - Global Clinical Document check for
                ...
                the Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013 and AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</assert>
            ...
            <report
                ...
                Dispense_Record_CDA_Implementation_Guide_vATS 4888.4-2013 and AMT_and_SNOMED_CT_AU_Concepts_Identifier_Requirements.</report>
...
-->
        ...
        <rule context="ext:asEntityIdentifier">
            ...
            <assert test="@classCode">Error: Dispense Record -
            ...
            <assert test="not(@classCode) or normalize-space(@classCode) != ''">Error: Dispense Record -
                Global Clinical Document check for "ext:asEntityIdentifier" tag -
            ...
            <assert test="ext:id">Error: Dispense Record -
            ...
            <!--
            <assert test="ext:id/@assigningAuthorityName">Error: Dispense Record -
            ...
            <!-- Other attributes of "ext:id" are being tested by Dispense_Record_Global_Checks.sch. -->
            ...
            <!-- The attributes of "ext:code" (code, codeSystem, codeSystemName, displayName) are being tested by Dispense_Record_Global_Checks.sch. -->
        ...
        <rule context="cda:name[not(
            ...
            <report test="cda:family and not(cda:family[@nullFlavor]) and normalize-space(cda:family) = ''"
                >Error: Dispense Record - Global Clinical Document check for "name" tag - The 'family' tag
        ...
        <rule context="cda:addr[not(ancestor::cda:birthplace)]">
            ...
            <assert test="
                ...
                >Error: Dispense Record - Global Clinical Document check for 'addr' tag -
