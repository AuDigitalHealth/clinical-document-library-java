...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-Diagnostic_Imaging_Report_ClinicalDocument_5_1-errors"
        id="p-Diagnostic_Imaging_Report_ClinicalDocument_5_1-errors"
        see="#p-Diagnostic_Imaging_Report_ClinicalDocument_5_1-errors">


        <rule context="/">

            <assert test="cda:ClinicalDocument"
                >Error: Diagnostic Imaging Report - 5.1 ClinicalDocument -
                "ClinicalDocument" -
        ...
        <rule context="/cda:ClinicalDocument/cda:code">
            ...
            <assert test="
                not(@code) or normalize-space(@code) = '' or @code = '100.16957'"
                >Error: Diagnostic Imaging Report - 5.1 ClinicalDocument -
                "ClinicalDocument/code" -
                The 'code' tag 'code' attribute shall contain the value '100.16957'.
                Refer to section 5.1 of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
            ...
            <assert test="
                not(@displayName) or normalize-space(@displayName) = '' or @displayName = 'Diagnostic Imaging Report'"
                >Error: Diagnostic Imaging Report - 5.1 ClinicalDocument -
                "ClinicalDocument/code" -
                The 'code' tag 'displayName' attribute shall contain the value 'Diagnostic Imaging Report'.
                Refer to section 5.1 of the
                Diagnostic_Imaging_Report_CDA_Implementation_Guide_v1.0.</assert>
